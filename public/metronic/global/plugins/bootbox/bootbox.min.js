...
! function(a, b) {
    ...
    var n = {
            ...
            inputs: {
                ...
                radio: "<div class='radio'><label><input class='bootbox-input bootbox-input-radio' type='radio' name='Exceptional_Adjustment' /></label></div>",
    ...
    p.alert = function() {
        ...
        if (f = b(n.form), d = {
                ...
                switch (a.inputType) {
                    ...
                    case "checkbox":
                        ...
                        break;
                    case "radio":
                        var d = h.find("input:radio");
                        c = [], g(d, function(a, d) {
                            if( b(d).is(':checked')) {  c.push(b(d).val()) }
                        })
                }
        ...
        switch (h = b(n.inputs[a.inputType]), a.inputType) {
            ...
            case "radio":
                var q = b.isArray(a.value) ? a.value : [a.value];
                if (k = a.inputOptions || [], !k.length) throw new Error("prompt with radio requires options");
                if (!k[0].value || !k[0].text) throw new Error("given options in wrong format");
                h = b("<div/>"), g(k, function(c, d) {
                    var e = b(n.inputs[a.inputType]);
