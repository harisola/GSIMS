...
class AccountsController extends Controller
{
  ...
  // return response()->json(array('success' => true, 'Gname'=>$Gname,'Snames'=>$Snames,'st'=>$st ));
    ...
    public function StudentApplicableForTaxes($list,$gross_and_additional_charges){
            ...
            // echo $received_amount=$this->calculate_arrier_adjustments($list['student_id']);
            $received_amount=$fee_bill_received->sumTotalPayments($list['student_id'],$list['a_session_id']);
    ...
    public function split_on($string, $num) {
        ...
        public function calculate_arrier_adjustments($student_id){
            ...
            return $remainig_amount=($total_payable-$received->getReceivedAmount($bill_id));//checking last bill in fee received table exists  or not
        ...
        public function getThisSessionTotalReceivedAmount(){
