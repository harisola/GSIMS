...
public function fetchFeeBill($gs_id){
            ...
            if($resource_fee_show==true){
                ...
                $this->createTable($pdf,97,number_format($resource_fee),34.2,'',5);
                $this->createTable($pdf,97,number_format($annual_resource_fee),49.5,'',5);
                $this->createTable($pdf,97,number_format($installment_resource_fee),66,'B',5);
            }else{
                $annual_resource_fee=0;
                $installment_resource_fee=0;
            }
