...
class super_profile extends Controller
{
        ...
        public function getSuperProfile(){
            ...
            return view('HR.staff.super_profile_view4')->with(array(
                ...
                $html .= '<td>'.date('g:i A',strtotime($profile->mon_in)).'-'.date('g:i A',strtotime($profile->mon_out)).'</td>';
                    ...
                    $super_flag = 0; 
                        ...
                        if($superDetail->super_profile_id ==  $super->ID && $superDetail->profile_id == $profile->id ) {  
                            ...
                            $super_flag = 1;
                            $html .= '<td>';
                        if($superDetail->is_on_mon == 1) {
                            $html .= '<a href="javascript:void(0)"  class="MonIN" data-placement="bottom" data-title="Morning" data-profile_id ="'.$superDetail->profile_id.'" data-super_profile="'.$superDetail->super_profile_id.'"data-pk="'.$superDetail->id.'" data-type="combodate">'.date("g:i A",strtotime($superDetail->mon_in)).
                              '</a> &nbsp; - &nbsp; <a href="javascript:void(0)"  class="MonOUT" data-placement="bottom" data-title="Afternoon" data-profile_id ="'.$superDetail->profile_id.'" data-super_profile="'.$superDetail->super_profile_id.'" data-pk="'.$superDetail->id.'" data-type="combodate">'.date("g:i A",strtotime($superDetail->mon_out)).'</a>';
                        } else {
                            $html .= '<a href="javascript:void(0)"  class="MonIN" data-placement="bottom" data-title="Morning" data-profile_id ="'.$superDetail->profile_id.'" data-super_profile="'.$superDetail->super_profile_id.'" data-pk="'.$superDetail->id.'" data-type="combodate">00:00:00
                              </a> &nbsp; - &nbsp; <a href="javascript:void(0)"  class="MonOUT" data-placement="bottom" data-title="Afternoon" data-profile_id ="'.$superDetail->profile_id.'" data-super_profile="'.$superDetail->super_profile_id.'" data-pk="'.$superDetail->id.'" data-type="combodate"> 00:00:00
                               </a>';
                        ...
                        if($super_flag == 0) {
                            $html .= '<td>';
                            $html .= '<a href="javascript:void(0)"  class="MonINInsert" data-placement="bottom" data-title="Morning" data-profile ="'.$profile->id.'" data-super="'.$super->ID.'" data-pk="1" data-type="combodate" data-url="'.url("InsertTimeIn").'">00:00:00
                              </a> &nbsp; - &nbsp; <a href="javascript:void(0)"  class="MonOUTInsert" data-placement="bottom" data-title="Afternoon" data-profile ="'.$profile->id.'" data-super="'.$super->ID.'" data-pk="1" data-type="combodate" data-url="'.url("InsertTimeOut").'"> 00:00:00
                               </a>
                              </td>';
                              } 
