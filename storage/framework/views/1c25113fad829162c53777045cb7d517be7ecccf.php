  ...
  <table class="table table-striped table-bordered table-hover" id="reportTable2">
                    <thead>
                      <tr>
                        ...
                        <?php if( !empty( $Staff_Attendance[0])): ?>
                          <?php $__currentLoopData = $Staff_Attendance[0]; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $sa): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <th> 
                            <?php
                              echo $sa['gen_date'];
                            ?>
                    ...
                    <tbody>
                      ...
                      <tr>
                        ...
                        <td>Time In</td>
                         ...
                         <?php if( !empty( $Staff_Attendance[$i] )): ?>
                          <?php $__currentLoopData = $Staff_Attendance[$i]; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $sa): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                           <td> <?php
                              echo $sa['tap_min'];
                            ?></td>
                          <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
