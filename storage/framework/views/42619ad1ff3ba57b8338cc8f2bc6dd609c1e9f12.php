 <table class="table table-striped table-bordered table-hover order-column dataTable no-footer" id="DetailsReceivingBillReport">
    ...
    <tr>
        <td width="80" style="text-align: center;"><?php echo e($i++); ?></td>
        <td><?php echo e($receiving_report_grade_wises->gs_id); ?></td>
        <td><?php echo e($receiving_report_grade_wises->gfid); ?></td>
        <td><?php echo e($receiving_report_grade_wises->std_status_code); ?></td>
        <td><?php echo e($receiving_report_grade_wises->grade_name); ?></td>
        <td><?php echo e($receiving_report_grade_wises->abridged_name); ?></td>
        <td><?php echo e($receiving_report_grade_wises->bill_cycle_no); ?></td>
        <td><?php echo e($receiving_report_grade_wises->gb_id); ?></td>
        <?php 
        ...
        <?php echo e(number_format($total_payable_rollover)); ?></td>
        ...
        <td class="total_smart_card_charges">
            <?php echo e(number_format(App\Models\Accounts\fee_bill::getAmountPaidOrNot($amount,$receiving_report_grade_wises->total_payable_yearly_charges))); ?>

        </td>
        <?php  $amount=$amount-$receiving_report_grade_wises->total_smart_card_charges;?>
        <td class="total_late_fee">
            <?php echo e(number_format(App\Models\Accounts\fee_bill::getAmountPaidOrNot($amount,$receiving_report_grade_wises->total_smart_card_charges))); ?>
        ...
        <td class="security_deposit"><?php echo e($receiving_report_grade_wises->security_deposit); ?></td>
        ...
        <td class=""></td>
        <td class=""><?php echo e($receiving_report_grade_wises->received_date); ?></td>
        <td class=""><?php echo e($receiving_report_grade_wises->payment_mode); ?></td>
        <td class=""><?php echo e($receiving_report_grade_wises->received_branch); ?></td>
