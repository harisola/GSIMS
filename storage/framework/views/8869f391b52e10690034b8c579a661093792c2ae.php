...
$.ajax({
url: "<?php echo e(url('/staff_recruitment_initiation_add')); ?>",
type:"POST",
cache:true,
...
$('#form_id').val(form_id);
$.ajax({
url: "<?php echo e(url('/get_staff_recruitment')); ?>",
type:"POST",
cache:true,
data: {
'_token': '<?php echo e(csrf_token()); ?>',
    ...
    if(data[i].old_status_id != null){
      ...
      /*  if(data[i].career_id == 1 || data[i].career_id == 2 || data[i].career_id == 3 || data[i].career_id == 4){
        ...
        if(data[i].date == '1970-01-01'){
            data[i].date = "<?php echo e(date('Y-m-d')); ?>"
        }                            
...
var form_id = $('#form_id').val();
$.ajax({
url: "<?php echo e(url('/update_presence')); ?>",
type:"POST",
cache:true,
data: {
'_token': '<?php echo e(csrf_token()); ?>',
...
url:"<?php echo e(url('/preperation_checks')); ?>",
success:function(e){
