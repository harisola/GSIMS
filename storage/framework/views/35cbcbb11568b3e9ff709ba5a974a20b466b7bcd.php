...
<!-- Start of left side -->
    <div class="col-md-9 fixed-height" id="profileDetail_Left" style="display: none;">
            <?php echo $__env->make('account_process.accounts.fee_bill_setup_right_side_main', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
    </div><!-- col-md-8 -->
</div><!-- row -->
<!-- End content section -->
<!--================================================== -->
...
$.ajax({
type:'POST',
data:{'_token': '<?php echo e(csrf_token()); ?>', 'ASID':Academic_Session_ID },
url:"<?php echo e(url('/render_html_right_side')); ?>",
dataType: "json",
async: false,
cache: false,
...
$.ajax({
type:'POST',
data:{'_token': '<?php echo e(csrf_token()); ?>', 'ASID':Installment_Setup2 },
url:"<?php echo e(url('/render_html_right_side_IS')); ?>",
dataType: "json",
async: false,
cache: false,
success: function(response)
...
type:'POST',
data:{'_token': '<?php echo e(csrf_token()); ?>', 'ASID':Installment_Setup2 },
url:"<?php echo e(url('/render_html_right_side_Other')); ?>",
dataType: "json",
async: false,
cache: false,
success: function(response)
...
confirm: {
  ...
  $.ajax({
type:'POST',
data: {'_token': '<?php echo e(csrf_token()); ?>', 'Formdata': $("#registerSubmit").serialize() },
url:"<?php echo e(url('/free_structure_post_data')); ?>",
dataType: "json",
async: false,
cache: false,
success: function(response)
...
confirm: {
  ...
  $.ajax({
type:'POST',
data: {'_token': '<?php echo e(csrf_token()); ?>', 'Formdata': $("#form_sample_1").serialize() },
url:"<?php echo e(url('/free_structure_post_data2')); ?>",
dataType: "json",
async: false,
cache: false,
success: function(response)
