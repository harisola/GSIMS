                                      ...
                                      <div class="row ">
                                         <div class="col-md-6">
                                            <div class="form-group">
                                               ...
                                               <div class="col-md-9">
                                                  <input type="text" class="form-control" placeholder="" value="<?php echo e($personalInfo[0]->staff_id); ?>" id="employe_id" disabled="" >
                                               </div>
                                               <input type="hidden" id="staff_id" value="<?php echo e($personalInfo[0]->staff_id); ?>" />
                                               <input type="hidden" id="staff_status" value="<?php echo e($personalInfo[0]->staff_status_name); ?>" />
                                            </div>
                                         </div>
                                         <!--/span-->
                                         <div class="col-md-6">
                                            <div class="form-group">
                                               ...
                                               <div class="col-md-9">
                                                  <input type="text"  class="form-control" placeholder="" value="<?php echo e($personalInfo[0]->gt_id); ?>" id="staffGTID" disabled="">
                                               </div>
                                            </div>
                                         </div>
                                         <!--/span-->
                                      ...
                                      <div class="row marginBottom20">
                                         <div class="col-md-6">
                                            <div class="form-group">
                                               ...
                                               <div class="col-md-9">
                                                  <input type="text" class="form-control item" placeholder="CNIC Full Name" id="cnic_fullnum" value="<?php echo e($personalInfo[0]->name); ?>">
                                               </div>
                                            </div>
                                         </div>
                                         <!--/span-->
                                         <div class="col-md-6">
                                            <div class="form-group">
                                               ...
                                               <div class="col-md-9">
                                                  <input type="text" class="form-control" placeholder="Full Name" id="full_num" maxlength="18" value="<?php echo e($personalInfo[0]->name); ?>">
                                               </div>
                                            </div>
                                         </div>
                                         <!--/span-->
                                            ...
                                            <div class="form-group">
                                               ...
                                               <div class="col-md-9">
                                                    <select class="form-control" id="nationality_txt" placeholder=" Select Nationality">
                                                          <option value="<?php echo e($personalInfo[0]->nationality); ?>"><?php echo e($personalInfo[0]->nationality); ?></option>
                                      ...
                                      <div class="row">
                                         <div class="col-md-6">
                                            <div class="form-group">
                                               ...
                                               <div class="col-md-9">
                                                  <!-- NIC masking: XXX -->
                                                  <input type="text" class="form-control" placeholder="Name Code" minlength="3" maxlength="3" id="namecode_txt" value="<?php echo e($personalInfo[0]->name_code); ?>">
                                               </div>
                                            </div>
                                         </div>
                                         <!--/span-->
                                      ...
                                      <div class="row marginBottom20">
                                         <div class="col-md-6">
                                            <div class="form-group">
                                               ...
                                               <div class="col-md-9">
                                                  ...
                                                  <input type="text" class="form-control" placeholder="CNIC" id="cnic_txt" value="<?php echo e($personalInfo[0]->nic); ?>">
                                               </div>
                                            </div>
                                         </div>
                                         <!--/span-->
                                         <div class="col-md-6">
                                            <div class="form-group">
                                               ...
                                               <div class="col-md-9">
                                                  <input type="email"  class="form-control" placeholder="Email(Personal)" id="email_txt" name="email_txt" value="<?php echo e($personalInfo[0]->emailpersonal); ?>">
                                               </div>
                                            </div>
                                         </div>
                                         <!--/span-->
                                            ...
                                            <div class="form-group">
                                               ...
                                               <div class="col-md-9">
                                                  <!-- Mobile phone   Masking: XXXX-XXXXXXX -->
                                                     <input type="phone" class="form-control " placeholder="" id="phonenum_txt" value="<?php echo e($personalInfo[0]->mobile_phone); ?>" Required>
                                               </div>
                                            </div>
                                         </div>
                                         <!--/span-->
                                            ...
                                            <div class="form-group">
                                               ...
                                               <div class="col-md-9">
                                                  <!-- Mobile phone Masking: XXX-XXXXXXX -->
                                                    <input type="phone" class="form-control" placeholder="" id="landline_txt" value="<?php echo e($personalInfo[0]->land_line); ?>">
                                               </div>
                                            </div>
                                         </div>
                                         <!--/span-->
                                      ...
                                      <div class="row marginBottom20">
                                         <div class="col-md-6">
                                            <div class="form-group">
                                               ...
                                               <div class="col-md-9">
                                                  <input type="date" class="form-control" placeholder="" id="doj_date" value="<?php echo e($personalInfo[0]->doj); ?>" disabled>
                                               </div>
                                            </div>
                                         </div>
                                         <!--/span-->
                                      ...
                                      <div class="row marginBottom20">
                                         <div class="col-md-6">
                                            <div class="form-group">
                                               ...
                                               <div class="col-md-9">
                                                  <input type="text" class="form-control" placeholder="" id="generation_email" value="<?php echo e($personalInfo[0]->email); ?>" disabled>
                                               </div>
                                            </div>
                                         </div>
                                         <!--/span-->
                                         <div class="col-md-6">
                                            <div class="form-group">
                                               ...
                                               <div class="col-md-9">
                                                  <select class="form-control" id="tap_in_campus" value="<?php echo e($personalInfo[0]->campus); ?>">
                                      ...
                                      <div class="row marginBottom20">
                                         <div class="col-md-6">
                                            <div class="form-group">
                                               ...
                                               <div class="col-md-9">
                                                  <input type="text" class="form-control" placeholder="" id="apartment_txt" value="<?php echo e($personalInfo[0]->apartment_no); ?>">
                                               </div>
                                            </div>
                                         </div>
                                         <!--/span-->
                                         <div class="col-md-6">
                                            <div class="form-group">
                                               ...
                                               <div class="col-md-9">
                                                  <input type="text" class="form-control" placeholder="" id="street_name_txt" value="<?php echo e($personalInfo[0]->street_name); ?>">
                                               </div>
                                            </div>
                                         </div>
                                         <!--/span-->
                                      ...
                                      <div class="row marginBottom20">
                                         <div class="col-md-6">
                                            <div class="form-group">
                                               ...
                                               <div class="col-md-9">
                                                  <input type="text" class="form-control" placeholder="" id="building_name_txt" value="<?php echo e($personalInfo[0]->building_name); ?>">
                                               </div>
                                            </div>
                                         </div>
                                         <!--/span-->
                                         <div class="col-md-6">
                                            <div class="form-group">
                                               ...
                                               <div class="col-md-9">
                                                  <input type="text" class="form-control" placeholder="" id="plot_no_txt" value="<?php echo e($personalInfo[0]->plot_no); ?>">
                                               </div>
                                            </div>
                                         </div>
                                         <!--/span-->
                                         ...
                                         <div class="col-md-6">
                                            <div class="form-group">
                                               ...
                                               <div class="col-md-9">
                                                  ...
                                                  <!-- <input type="text" class="form-control" placeholder="" id="region_txt" value="<?php echo e($personalInfo[0]->region); ?>">
 -->
                                                  <select class="form-control"  id="region_txt" >
                                                    <!-- <option  ><?php echo e($personalInfo[0]->region); ?></option> -->
                                         ...
                                         <div class="col-md-6">
                                            <div class="form-group">
                                               ...
                                               <div class="col-md-9">
                                                  <!-- <input type="text" class="form-control" placeholder="" id="sub_region_txt" value="<?php echo e($personalInfo[0]->sub_region); ?>"> -->
