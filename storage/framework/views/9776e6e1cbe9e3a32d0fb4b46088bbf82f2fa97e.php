                ...
                <div class="inputs">
                    <div class="portlet-input">
                        <div class="input-icon right">
                            <a class="icon-magnifier" id="btn_search" href="javascript:void(0)" onclick='fnClassList(<?php echo e(json_encode($class_list)); ?>)'></a>
...
var fnClassList = function(data){
    ...
    if(typeof(result) === 'object' && result.length == 0){
        ...
        if(typeof(findStudent) != 'undefined'){
            $('.student-pic').attr('src', "<?php echo e(constant('STUDENT_PIC_150')); ?>"+findStudent.gr_no+".png");
            ...
            $('.student-pic').attr('src', "<?php echo e(constant('STUDENT_PIC_150')); ?>NoPic.png");
 ...
 function arrearsAddUpdate(){
    ...
    if(selectedForm.valid()){
        $.ajax({
            type:"POST",
            url:"<?php echo e(url('/addUpdateArrear')); ?>",
            data:{
...
//zk Function for Add Comma In Amount Numbers//
 ...
 function  getArrearAndAdjustmentData() {
    ...
    $.ajax({
            ...
            type:"POST",
            url:"<?php echo e(url('/getArrearAndAdjustmentData')); ?>",
            data:{
                "_token": "<?php echo e(csrf_token()); ?>",
            },
            success:function(e){
...
function updateArrear(data,amount){
    ...
    $.ajax({
        ...
        success:function(e){
            ...
            $('.student-pic').attr('src', "<?php echo e(constant('STUDENT_PIC_150')); ?>"+jsonData[0].gr_no+".png");
