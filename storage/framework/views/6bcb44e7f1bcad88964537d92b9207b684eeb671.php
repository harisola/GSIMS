      ...
      <tr>
         <td rowspan="2" width="25%"><h3 class="text-center">Call for<br />Part B</h3>
            <div class="text-center">
              <div class="text-center">
                  <img id="status1_1" src="img/AllocationIcon.png" />&nbsp;&nbsp;
                  <img id="status1_2" src="img/CommunicationIcon.png" />&nbsp;&nbsp;
                  <img id="status1_3" src="img/PresenceIcon.png" />&nbsp;&nbsp;
                  <img id="status1_4" src="img/FollowUpIcon.png" />&nbsp;&nbsp;
              </div>
            </div>
         </td>
      </tr>
         ...
         <td>
            <div class="row">
               ...
               <div class="col-md-6 KashifSolangi" style="padding-right:5px;">
                  <input type="date" class="form-control" id="applicant_next_step_allocation_date_11" min="<?php echo e(date('Y-m-d')); ?>">
               </div><!-- col-md-6 -->
