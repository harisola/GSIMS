      ...
      'createdphoto150' => string 'assets/photos/hcm/150x150/staff/1085.png' (length=40) 
                                            ...
                                            <tbody>
                                               ...
                                               <?php if( !empty( $Staffinfo )): ?>
                                                ...
                                                <?php $__currentLoopData = $Staffinfo; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $sr): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?> 



                                    <tr data-eattendance_id="<?php  echo $sr['Eattendance_id']  ?>" data-editid="<?php  echo $sr['Edit_id']  ?>" data-edittype="<?php  echo $sr['Edit_type']  ?>"  data-rowid="<?php  echo $sr['Approval_id']  ?>" data-type="<?php  echo $sr['Approval_Title']  ?>">
                                                    <td> <?php  echo $sr['Approval_Title']  ?> </td>
                                                    <td> 
    <div class="adjustment_staff_info_container">
       <img class="user-pic rounded tooltips" data-original-title="<?php  echo $sr['Gt_id']  ?>" src="<?php  echo $sr['photo150']  ?>"> 
       <?php   echo $sr['Staff_abridged_name']  ?>

       <?php   echo $sr['Name_code']  ?>

       <?php   echo $sr['Designation']  ?>
    </div>
                                                    ...
                                                    <td> <?php  echo $HtmlUPermission  ?> </td>
