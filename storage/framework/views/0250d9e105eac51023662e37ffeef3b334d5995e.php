     ...
     <div class="allocationArea">
               <ul class="nav nav-tabs">
                   ...
                   <li>
                    ...
                    <li>
                       <a href="#studentInterimtoday" data-toggle="tab"> Recruitment 2019 | Status Report 3 </a>
                   </li>
                 </ul>
                                ...
                                <div class="col-md-12 paddingRight0">
                                    <div class="portlet light bordered padding0 marginBottom0"  style="">
                                        ...
                                        <div class="row customRow">
                                              ...
                                              <div class="col-md-3" id="dates_container">
                                                <label>Applied Date</label>
                                                
                                                    <input type="date" class="form-control" id="date_depart1" >

                                              </div>
                                              <div class="col-md-3">
                                                <label>Applied Date To</label>
                                                
                                                <input type="date" class="form-control" id="date_depart2" >
                                          ...
                                          <!--  <div class="col-md-3" id="departs_container" >
                                              ...
                                              <div class="col-md-3" id="subjects_container">
                                                <label>Subject</label>
                                                <select id="subjects" class="form-control subjects" multiple="multiple">
                                                ...
                                                <div class="col-md-3" id="designations_container" style="margin-top: 11px;">
                                                <label>Designation</label>
                                                <select id="designations" class="form-control designations" multiple="multiple">
                                              ...
                                              <div class="col-md-3" id="campus_container" style="margin-top: 11px;">
                                                <label>Campus</label>
                                                ...
                                                <div class="col-md-3" id="Onlinew_container" style="margin-top: 11px;">
                                                ...
                                                <select id="Onlinew" class="form-control Onlinew">
                                                  ...
                                                  <div class="col-md-3">
                                                    <label>&nbsp;</label><br />
                                                     ...
                                                     <input type="button" id="filter_report_recuriment" data-pdf="0" class="btn btn-group green filter_report_recuriment" value="Generate Report" style="width: 100%;">
                                                  </div>
                                                </div><!-- row -->
                                            <div class="portlet-body padding20 " >
                                                <hr />
...
$(document).ready(function() {
         ...
         numberDisplayed: 1
           ...
           numberDisplayed: 1
            ...
            $(document).on("change", "#designations", function(){
             var designations_name = [];
            $.each($("#designations option:selected"), function(){            
               designations_name.push($(this).val());
 ...
 $(document).on("click",".filter_report_recuriment",function(){
    $('#Generations_AjaxLoader').show();
        ...
        var formdata =      'departs='+$('#departs').val()+'&subjects='+$('#subjects').val() +'&date_depart1='+$('#date_depart1').val() +'&date_depart2='+$('#date_depart2').val()+'&designations='+$('#designations').val()+'&campus='+$('#campus').val()+'&Onlinew='+$('#Onlinew').val()
