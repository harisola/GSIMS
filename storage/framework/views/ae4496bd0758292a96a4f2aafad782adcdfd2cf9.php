                ...
                <div class="portlet light bordered padding0 marginBottom0">
                    ...
                    <div class="row customRow">
                            ...
                            <div class="col-md-3" id="sectionFilter_container">
                                ...
                                <?php for( $a=1; $a < 9; $a++ ): ?>: 
                                    <option value="<?php echo $a; ?> "> Bill cycle <?php echo $a; ?></option>
                                <?php endfor; ?>; 
...
function Ajax_Call(MisType,Billcycleno,Adm_date_picker)
{
 ...
 if( MisType != '' ) 
 {
    ...
    $.ajax({
        type:"POST",
        cache:true,
        url:"<?php echo e(url('/table_ajax_fee_bill')); ?>",
        data:
        {
            "MisType":MisType,
...
type:"POST",
cache:true,
url:"<?php echo e(url('/calendar_test_II')); ?>",
data:{
Tap_value:Tap_value,
"_token": "<?php echo e(csrf_token()); ?>",
},
        ...
        loadScript("<?php echo e(URL::to('metronic')); ?>/pages/scripts/profile.js", function(){
            ...
            loadScript("<?php echo e(URL::to('metronic')); ?>/pages/scripts/table-datatables-managed.js", function(){
                loadScript("<?php echo e(URL::to('metronic')); ?>/pages/scripts/table-datatables-managed.min.js", function(){
                    ...
                    loadScript("<?php echo e(URL::to('metronic')); ?>/global/plugins/moment.min.js", function(){
                        loadScript("<?php echo e(URL::to('metronic')); ?>/global/plugins/bootstrap-daterangepicker/daterangepicker.min.js", function(){
                            loadScript("<?php echo e(URL::to('metronic')); ?>/global/plugins/bootstrap-datepicker/js/bootstrap-datepicker.min.js", function(){	

                                loadScript("<?php echo e(URL::to('metronic')); ?>/global/plugins/bootstrap-timepicker/js/bootstrap-timepicker.min.js", function(){
                                    loadScript("<?php echo e(URL::to('metronic')); ?>/global/plugins/bootstrap-datetimepicker/js/bootstrap-datetimepicker.min.js", function(){

                                        loadScript("<?php echo e(URL::to('metronic')); ?>/global/plugins/select2/js/select2.full.min.js", function(){
                                            loadScript("<?php echo e(URL::to('metronic')); ?>/pages/scripts/components-date-time-pickers.min.js", function(){
                                                loadScript("<?php echo e(URL::to('metronic')); ?>/pages/scripts/table-datatables-ajax.min.js", function(){

                                                    loadScript("<?php echo e(URL::to('metronic')); ?>/global/plugins/ladda/spin.min.js", function(){
                                                        loadScript("<?php echo e(URL::to('metronic')); ?>/global/plugins/ladda/ladda.min.js", function(){
                                                            loadScript("<?php echo e(URL::to('metronic')); ?>/pages/scripts/ui-buttons-spinners.min.js", function(){
