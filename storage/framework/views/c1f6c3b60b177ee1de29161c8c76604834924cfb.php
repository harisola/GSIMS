                                    ...
                                    <div class="modal-dialog">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body interim_card_div" style="float:left;width:100%;">
                                                ...
                                                <?php echo $__env->make('attendance.staff.staff_attendance_modal', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
                                                <!-- tab_basic_edit End -->
                                            </div><!-- modal-body -->
                                        </div><!-- modal-content -->
                                    </div><!-- modal-dialog -->
...
$(document).ready(function(){
    ...
    $("#guest_btn_default").click(function(){
        ...
        $("#InterimCardTapBtn").click(function(){
                ...
                { 
                    ...
                    $.ajax({
                        cache:true,
                        url:"<?php echo e(url('/get_fetch_staff_pix')); ?>",
                        data:{ 
                            "staff_id":staff_id
                        },
                        method:"GET",
                ...
                { //console.log("if");
                    ...
                    $('.childList').text("");
                     ...
                     // var _token = $('input[name="_token"]').val();
                        ...
                        $.ajax({
                            cache:true,
                            url:"<?php echo e(url('/student_parent_daypass_info')); ?>",
                            data:{ 
                                // "gf_id": $('.gf_id').val(),
                                "gf_id":select_gfid,
                                "Gr_no":Gr_no,
    ...
    function Interim_table(){
        ...
        $.ajax({
            cache:true,
            url:"<?php echo e(url('/interim_table_list')); ?>",
            method:"GET",
            success:function(data)
            { 
            $('#StaffList_ZiaKashif').html(data);
    ...
    function Parent_Interim_table(){
        ...
        $.ajax({
            cache:true,
            url:"<?php echo e(url('/interim_parent_table_list')); ?>",
            method:"GET",
            data:{ 
                "type_id":type_id,
                "type_id1":type_id1,
    ...
    function Visitor_Interim_table(){
        ...
        $.ajax({
            cache:true,
            url:"<?php echo e(url('/interim_visitor_table_list')); ?>",
            method:"GET",
            data:{ 
                "type_id":type_id,
                "type_id1":type_id1,
        ...
        if( $(this).val() != '' &&  $(this).val().length > 9 ){ // This will prevent event triggering more then once
            if( $(this).val().length == 10 )
            {
                ...
                function parents_Interim_tap(){
                    $.ajax({
                        cache:true,
                        url:"<?php echo e(url('/tap_parent_save_data')); ?>",
                        data:{
                            "RFID": TapEventValue,
                            "location": 5, 
                        },
                ...
                //     $.ajax({
                //         cache:true,
                //         url:"<?php echo e(url('/tap_visitor_save_data')); ?>",
                //         data:{
                //             "RFID": TapEventValue,
                //             "location": 5, 
                //         },
    ...
    function admission_foam(){
        ...
        if($('#admission_rfid').val() != '' && $('#admission_rfid').val().length >9){ 
                ...
                $.ajax({
                    cache:true,
                    url:"<?php echo e(url('/admission_save_data')); ?>",
                    data:{ 
    ...
    function applicant_foam(){
        ...
        if($('#applicant_rfid').val() != '' && $('#applicant_rfid').val().length >9){ 
                ...
                $.ajax({
                    cache:true,
                    url:"<?php echo e(url('/applicant_save_data')); ?>",
                    data:{ 
    ...
    function vendor_foam(){
        ...
        if($('#vendor_rfid').val() != '' && $('#vendor_rfid').val().length >9){ 
                ...
                $.ajax({
                    cache:true,
                    url:"<?php echo e(url('/vendor_save_data')); ?>",
                    data:{ 
    ...
    function worker_foam(){
        ...
        if($('#worker_rfid').val() != '' && $('#worker_rfid').val().length >9){ 
                ...
                $.ajax({
                    cache:true,
                    url:"<?php echo e(url('/worker_save_data')); ?>",
                    data:{ 
    ...
    function guest_foam(){
        ...
        if($('#guest_rfid').val() != '' && $('#guest_rfid').val().length >9){ 
                ...
                $.ajax({
                    cache:true,
                    url:"<?php echo e(url('/guest_save_data')); ?>",
                    data:{ 
                        "guest_nic":guest_nic,
 ...
 ****************************************************/
    ...
    $('#search_staff_name').keyup(function(){ 
        ...
        if( query != '')
        {
            ...
            $.ajax({
                cache:true,
                url:"<?php echo e(url('/fetch_autocomplete')); ?>",
                method:"POST",
    ...
    $('#search_student_name').keyup(function(){ 
        ...
        if( query != '')
        {
            ...
            $.ajax({
                cache:true,
                url:"<?php echo e(url('/fetch_familylist_autocomplete')); ?>",
                method:"POST",
                data:{query:query, _token:_token},
                success:function(data)
                {
