                                        ...
                                        <div class="theme-options">
                                            <div class="theme-option">
                                                ...
                                                <select multiple="multiple" id="StaffView_Filter_Profile" class="layout-option form-control input-sm">
                                                    ...
                                                    <?php $__currentLoopData = $profile_detail; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $profile): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?> { ?>
                                                    <option value="<?php echo e($profile->name); ?>" ><?php echo e($profile->name); ?></option>
                                            ...
                                            <div class="theme-option">
                                                ...
                                                <select multiple="multiple" id="StaffView_Filter_Department" class="layout-option form-control input-sm">
                                                    <?php $__currentLoopData = $staff; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $staff_detail): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?> { ?>
                                                        <option value="<?php echo e($staff_detail->c_bottomline); ?>"> <?php echo e($staff_detail->c_bottomline); ?> </option>
                                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                                   <option value=""></option>
                                                </select>
                                            </div>
                            ...
                            <table class="table table-striped table-hover table-bordered" id="weekly_timesheet_table">
                                <thead>
                                    <tr style="background:#fff;" role="row">
                                        ...
                                        <th style="display: none;"></th>
                                        <th style="display: none;"></th>
                                        <?php $__currentLoopData = $get_weeks; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $week): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <th>
                                           <div class="input-group">
                                               
                                                <input id="time_in_allStaff_<?php echo e($key); ?>" type="time" class="form-control input-sm">
                                                <span class="input-group-addon"><i class="fa fa-sign-in"></i></span>
                                            </div> 
                                            <div class="input-group">
                                                <input id="time_out_allStaff_<?php echo e($key); ?>" type="time"  class="form-control input-sm" >
                                                <span class="input-group-addon"><i class="fa fa-sign-out"></i></span>
                                            </div>
                                            <div class="input-group">
                                                <input onclick="updateAllStaffTime('<?php echo e($week->date); ?>', <?php echo e($key); ?>)" type="button" value="Apply for All" class="btn btn-group  green-jungle" style="width: 100%;">
                                            </div>
                                        </th>
                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                        <th></th>
                                ...
                                <?php  $holidayHtml = [];   ?> 
                                    ...
                                    <?php $__currentLoopData = $get_weeks; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $week): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        ...
                                        <th class="text-center" data-id="<?php echo e($week->id); ?>"> <?php echo e(date('D',strtotime($week->date))); ?> 
                                        <br />
                                        <small> <?php echo e(date('d M Y',strtotime($week->date))); ?></small> </th>
                                ...
                                <?php $__currentLoopData = $weeklyTimeSheetData; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            
            
                                    <tr> 
                                       
                                        <td> <strong><?php echo e($item->abridged_name); ?></strong> <br /><small><strong>Dept: <?php echo e($item->c_bottomline); ?></strong></small><br /><small><strong>Desg: <?php echo e($item->c_topline); ?></strong></small><br /><small><strong>Profile: <?php echo e($item->tt_profile_name); ?></strong></small> </td>
                                        <td style="display:none"><?php echo e($item->c_bottomline); ?></td>
                                        <td style="display:none"><?php echo e($item->tt_profile_name); ?></td>
                                        <td style="display:none"><?php echo e($item->campus); ?></td>
            
                                        <td class="text-center ">
                                            <div class="input-group">
                                                <input type="hidden" id="<?php echo e($item->d1_id); ?>_in" value="0">
                                                <input type="hidden" id="<?php echo e($item->d1_id); ?>_out" value="0">
                                                <input  <?php echo e(($holidayHtml[0] == '' || $item->d1_holidayFlag != 0 ) ? 'type=time' : 'type=text onclick=removeHoliday(this,"'.$item->d1_id.'_in") '); ?>   class="<?php echo e($item->staff_id); ?>_timeIn0 form-control input-sm"  <?php  
                                                echo ($item->d1_id != '') ? 'onChange="updateData('. $item->d1_id .',&apos;time_in&apos;, this)" ' : 'onChange="addData('.$item->staff_id.',&apos;time_in&apos;,&apos;d1&apos;,&apos;'.$item->d1_date.'&apos;)"';
                                                 ?> 
                                                id="<?php echo e($item->d1_id == '' ? 'd1_timeIn_'.$item->staff_id:$item->d1_id . '_timeIn'); ?>"   value="<?php echo e($holidayHtml[0] == '' || $item->d1_holidayFlag != 0  ? $item->d1_in : 'N/A'); ?>" />
                                                <span class="input-group-addon"><i class="fa fa-sign-in"></i></span>
                                            </div><!-- input-group --> 
                                            <div class="input-group">
                                                <input   <?php echo e(($holidayHtml[0] == '' || $item->d1_holidayFlag != 0 ) ? 'type=time' : 'type=text onclick=removeHoliday(this,"'.$item->d1_id.'_out") '); ?>   <?php  
                                                echo ($item->d1_id != '') ? 'onChange="updateData('. $item->d1_id .',&apos;time_out&apos;, this)" ' : 'onChange="addData('.$item->staff_id.',&apos;time_out&apos;,&apos;d1&apos;,&apos;'.$item->d1_date.'&apos;)"';
                                                 ?> 
                                                 id="<?php echo e($item->d1_id == '' ? 'd1_timeOut_'.$item->staff_id:$item->d1_id . '_timeOut'); ?>" class="<?php echo e($item->staff_id); ?>_timeOut0 form-control input-sm"   value="<?php echo e($holidayHtml[0] == ''   || $item->d1_holidayFlag != 0 ? $item->d1_out : 'N/A'); ?>" />
                                                <span class="input-group-addon"><i class="fa fa-sign-out"></i></span>
                                            </div><!-- input-group --> 
                                             <?php   echo ($item->d1_on_leave == 1 )? '<a href="javascript:;" class="popovers" data-container="body" data-trigger="hover" data-placement="top" data-content="<h5>Authorized Leave for the day with a <strong>'.$item->d1_perc.'%</strong> paid compensation.</h5>" data-original-title="<h4 style=&#39;margin:0;&#39;>Leave Status</h4>" data-html="true"><img src="img/LeaveIconApplied.png" width="20"></a>': '<a class="tooltips" data-placement="bottom" data-original-title="Leave Status"><img src="img/LeaveIcon.png" width="20"></a>';   ?>  
                                        ...
                                        <td class="text-center ">
                                            <div class="input-group">
                                                <input type="hidden" id="<?php echo e($item->d2_id); ?>_in" value="0">
                                                <input type="hidden" id="<?php echo e($item->d2_id); ?>_out" value="0">
                                                <input <?php echo e($holidayHtml[1] == ''   || $item->d2_holidayFlag != 0  ? 'type=time' : 'type=text onclick=removeHoliday(this,"'.$item->d2_id.'_in") '); ?>

                                                <?php  
                                                echo ($item->d2_id != '') ? 'onChange="updateData('. $item->d2_id .',&apos;time_in&apos;, this)" ' : 'onChange="addData('.$item->staff_id.',&apos;time_in&apos;,&apos;d2&apos;,&apos;'.$item->d2_date.'&apos;)"';
                                                 ?> 
                                                  id="<?php echo e($item->d2_id == '' ? 'd2_timeIn_'.$item->staff_id:$item->d2_id . '_timeIn'); ?>" class="<?php echo e($item->staff_id); ?>_timeIn1 form-control input-sm"  value="<?php echo e($holidayHtml[1] == '' || $item->d2_holidayFlag != 0  ? $item->d2_in : 'N/A'); ?>" />
                                                <span class="input-group-addon"><i class="fa fa-sign-in"></i></span>
                                            </div><!-- input-group -->  
                                            <div class="input-group">
                                                <input <?php echo e($holidayHtml[1] == '' || $item->d2_holidayFlag != 0 ? 'type=time' : 'type=text onclick=removeHoliday(this,"'.$item->d2_id.'_out") '); ?>    <?php  
                                                echo ($item->d2_id != '') ? 'onChange="updateData('. $item->d2_id .',&apos;time_out&apos;, this)" ' : 'onChange="addData('.$item->staff_id.',&apos;time_out&apos;,&apos;d2&apos;,&apos;'.$item->d2_date.'&apos;)"';
                                                 ?>
            
                                                 id="<?php echo e($item->d2_id == '' ? 'd2_timeOut_'.$item->staff_id:$item->d2_id . '_timeOut'); ?>" class="<?php echo e($item->staff_id); ?>_timeOut1 form-control input-sm"   value="<?php echo e($holidayHtml[1] == '' || $item->d2_holidayFlag != 0 ? $item->d2_out : 'N/A'); ?>"/>
                                                <span class="input-group-addon"><i class="fa fa-sign-out"></i></span>
                                            </div><!-- input-group --> 
                                        ...
                                        <td class="text-center ">
                                            <div class="input-group">
                                                <input type="hidden" id="<?php echo e($item->d3_id); ?>_in" value="0">
                                                <input type="hidden" id="<?php echo e($item->d3_id); ?>_out" value="0">
                                                <input <?php echo e($holidayHtml[2] == '' || $item->d3_holidayFlag != 0 ? 'type=time' : 'type=text onclick=removeHoliday(this,"'.$item->d3_id.'_in")'); ?>  <?php  
                                                echo ($item->d3_id != '') ? 'onChange="updateData('. $item->d3_id .',&apos;time_in&apos;, this)" ' : 'onChange="addData('.$item->staff_id.',&apos;time_in&apos;,&apos;d3&apos;,&apos;'.$item->d3_date.'&apos;)"';
                                                 ?>
                                                 id="<?php echo e($item->d3_id == '' ? 'd3_timeIn_'.$item->staff_id:$item->d3_id . '_timeIn'); ?>" class="<?php echo e($item->staff_id); ?>_timeIn2 form-control input-sm"  value="<?php echo e($holidayHtml[2] == '' || $item->d3_holidayFlag != 0 ? $item->d3_in : 'N/A'); ?>" />
                                                <span class="input-group-addon"><i class="fa fa-sign-in"></i></span>
                                            </div><!-- input-group -->  
                                            <div class="input-group">
            
                                                <input <?php echo e($holidayHtml[2] == '' || $item->d3_holidayFlag != 0 ? 'type=time' : 'type=text onclick=removeHoliday(this,"'.$item->d3_id.'_out")'); ?> <?php  
                                                echo ($item->d3_id != '') ? 'onChange="updateData('. $item->d3_id .',&apos;time_out&apos;, this)" ' : 'onChange="addData('.$item->staff_id.',&apos;time_out&apos;,&apos;d3&apos;,&apos;'.$item->d3_date.'&apos;)"';
                                                 ?>  id="<?php echo e($item->d3_id == '' ? 'd3_timeOut_'.$item->staff_id:$item->d3_id . '_timeOut'); ?>" class="<?php echo e($item->staff_id); ?>_timeOut2 form-control input-sm" 
                                                value="<?php echo e($holidayHtml[2] == '' || $item->d3_holidayFlag != 0 ? $item->d3_out : 'N/A'); ?>"  />
                                                <span class="input-group-addon"><i class="fa fa-sign-out"></i></span>
                                            </div><!-- input-group --> 
                                        ...
                                        <td class="text-center">
                                            <div class="input-group">
                                                <input type="hidden" id="<?php echo e($item->d4_id); ?>_in" value="0">
                                                <input type="hidden" id="<?php echo e($item->d4_id); ?>_out" value="0">                                   
                                                <input <?php echo e($holidayHtml[3] == '' || $item->d4_holidayFlag != 0 ? 'type=time' : 'type=text onclick=removeHoliday(this,"'.$item->d4_id.'_in")'); ?> <?php  
                                                echo ($item->d4_id != '') ? 'onChange="updateData('. $item->d4_id .',&apos;time_in&apos;, this)" ' : 'onChange="addData('.$item->staff_id.',&apos;time_in&apos;,&apos;d4&apos;,&apos;'.$item->d4_date.'&apos;)"';
                                                 ?>
            
                                                 id="<?php echo e($item->d4_id == '' ? 'd4_timeIn_'.$item->staff_id:$item->d4_id . '_timeIn'); ?>" class="<?php echo e($item->staff_id); ?>_timeIn3 form-control input-sm" value="<?php echo e($holidayHtml[3] == '' || $item->d4_holidayFlag != 0 ? $item->d4_in : 'N/A'); ?>" />
                                                <span class="input-group-addon"><i class="fa fa-sign-in"></i></span>
                                            </div><!-- input-group --> 
                                            <div class="input-group">   
                                                <input <?php echo e($holidayHtml[3] == '' || $item->d4_holidayFlag != 0 ? 'type=time' : 'type=text onclick=removeHoliday(this,"'.$item->d4_id.'_out")'); ?> <?php  
                                                echo ($item->d4_id != '') ? 'onChange="updateData('. $item->d4_id .',&apos;time_out&apos;, this)" ' : 'onChange="addData('.$item->staff_id.',&apos;time_out&apos;,&apos;d4&apos;,&apos;'.$item->d4_date.'&apos;)"';
                                                 ?>
            
                                                 id="<?php echo e($item->d4_id == '' ? 'd4_timeOut_'.$item->staff_id:$item->d4_id . '_timeOut'); ?>" class="<?php echo e($item->staff_id); ?>_timeOut3 form-control input-sm" value="<?php echo e($holidayHtml[3] == '' || $item->d4_holidayFlag != 0 ? $item->d4_out : 'N/A'); ?>"  />
                                                <span class="input-group-addon"><i class="fa fa-sign-out"></i></span>
                                            </div><!-- input-group --> 
                                        ...
                                        <td class="text-center ">
                                            <div class="input-group">
                                                <input type="hidden" id="<?php echo e($item->d5_id); ?>_in" value="0">
                                                <input type="hidden" id="<?php echo e($item->d5_id); ?>_out" value="0">                                
                                                <input <?php echo e($holidayHtml[4] == '' || $item->d5_holidayFlag != 0 ? 'type=time' : 'type=text onclick=removeHoliday(this,"'.$item->d5_id.'_in")'); ?> <?php  
                                                echo ($item->d5_id != '') ? 'onChange="updateData('. $item->d5_id .',&apos;time_in&apos;, this)" ' : 'onChange="addData('.$item->staff_id.',&apos;time_in&apos;,&apos;d5&apos;,&apos;'.$item->d5_date.'&apos;)"';
                                                 ?>
            
                                                id="<?php echo e($item->d5_id == '' ? 'd5_timeIn_'.$item->staff_id:$item->d5_id . '_timeIn'); ?>" class="<?php echo e($item->staff_id); ?>_timeIn4 form-control input-sm" value="<?php echo e($holidayHtml[4] == '' || $item->d5_holidayFlag != 0 ? $item->d5_in : 'N/A'); ?>"  />
                                                <span class="input-group-addon"><i class="fa fa-sign-in"></i></span>
                                            </div><!-- input-group --> 
                                            <div class="input-group">
                                                <input <?php echo e($holidayHtml[4] == '' || $item->d5_holidayFlag != 0 ? 'type=time' : 'type=text onclick=removeHoliday(this,"'.$item->d5_id.'_out")'); ?>  <?php  
                                                echo ($item->d5_id != '') ? 'onChange="updateData('. $item->d5_id .',&apos;time_out&apos;, this)" ' : 'onChange="addData('.$item->staff_id.',&apos;time_out&apos;,&apos;d5&apos;,&apos;'.$item->d5_date.'&apos;)"';
                                                 ?>
            
                                                  id="<?php echo e($item->d5_id == '' ? 'd5_timeOut_'.$item->staff_id:$item->d5_id . '_timeOut'); ?>" class="<?php echo e($item->staff_id); ?>_timeOut4 form-control input-sm" value="<?php echo e($holidayHtml[4] == '' || $item->d5_holidayFlag != 0 ? $item->d5_out : 'N/A'); ?>"   />
                                                <span class="input-group-addon"><i class="fa fa-sign-out"></i></span>
                                            </div><!-- input-group --> 
                                        ...
                                        <td class="text-center ">
                                            <div class="input-group">
                                                <input type="hidden" id="<?php echo e($item->d6_id); ?>_in" value="0">
                                                <input type="hidden" id="<?php echo e($item->d6_id); ?>_out" value="0">                                
                                                <input <?php echo e($holidayHtml[5] == '' || $item->d6_holidayFlag != 0 ? 'type=time' : 'type=text onclick=removeHoliday(this,"'.$item->d6_id.'_in")'); ?>  <?php  
                                                echo ($item->d6_id != '') ? 'onChange="updateData('. $item->d6_id .',&apos;time_in&apos;, this)" ' : 'onChange="addData('.$item->staff_id.',&apos;time_in&apos;,&apos;d6&apos;,&apos;'.$item->d6_date.'&apos;)"';
                                                 ?>
                                                 id="<?php echo e($item->d6_id == '' ? 'd6_timeIn_'.$item->staff_id:$item->d6_id . '_timeIn'); ?>" class="<?php echo e($item->staff_id); ?>_timeIn5 form-control input-sm" value="<?php echo e($holidayHtml[5] == '' || $item->d6_holidayFlag != 0 ? $item->d6_in : 'N/A'); ?>"/>
                                                <span class="input-group-addon"><i class="fa fa-sign-in"></i></span>
                                            </div><!-- input-group --> 
                                            <div class="input-group">
                                                <input <?php echo e($holidayHtml[5] == '' || $item->d6_holidayFlag != 0 ? 'type=time' : 'type=text onclick=removeHoliday(this,"'.$item->d6_id.'_out")'); ?> <?php  
                                                echo ($item->d6_id != '') ? 'onChange="updateData('. $item->d6_id .',&apos;time_out&apos;, this)" ' : 'onChange="addData('.$item->staff_id.',&apos;time_out&apos;,&apos;d6&apos;,&apos;'.$item->d6_date.'&apos;)"';
                                                 ?>
                                                 id="<?php echo e($item->d6_id == '' ? 'd6_timeOut_'.$item->staff_id:$item->d6_id . '_timeOut'); ?>" class="<?php echo e($item->staff_id); ?>_timeOut5 form-control input-sm"  value="<?php echo e($holidayHtml[5] == '' || $item->d6_holidayFlag != 0 ? $item->d6_out : 'N/A'); ?>"  />
                                                <span class="input-group-addon"><i class="fa fa-sign-out"></i></span>
                                            </div><!-- input-group --> 
                                        ...
                                        <td class="text-center">
                                            <div class="input-group">
                                                <input type="hidden" id="<?php echo e($item->d7_id); ?>_in" value="0">
                                                <input type="hidden" id="<?php echo e($item->d7_id); ?>_out" value="0">                                
                                                <input <?php echo e($holidayHtml[6] == '' || $item->d7_holidayFlag != 0 ? 'type=time' : 'type=text onclick=removeHoliday(this,"'.$item->d7_id.'_in")'); ?> <?php  
                                                echo ($item->d7_id != '') ? 'onChange="updateData('. $item->d7_id .',&apos;time_in&apos;, this)" ' : 'onChange="addData('.$item->staff_id.',&apos;time_in&apos;,&apos;d7&apos;,&apos;'.$item->d7_date.'&apos;)"';
                                                 ?>
                                                  id="<?php echo e($item->d7_id == '' ? 'd7_timeIn_'.$item->staff_id:$item->d7_id . '_timeIn'); ?>" class="<?php echo e($item->staff_id); ?>_timeIn6 form-control input-sm"  value="<?php echo e($holidayHtml[6] == '' || $item->d7_holidayFlag != 0 ? $item->d7_in : 'N/A'); ?>"   />
                                                <span class="input-group-addon"><i class="fa fa-sign-in"></i></span>
                                            </div><!-- input-group --> 
                                            <div class="input-group">
                                                <input  <?php echo e($holidayHtml[6] == '' || $item->d7_holidayFlag != 0 ? 'type=time' : 'type=text onclick=removeHoliday(this,"'.$item->d7_id.'_out")'); ?>   <?php  
                                                echo ($item->d7_id != '') ? 'onChange="updateData('. $item->d7_id .',&apos;time_out&apos;, this)" ' : 'onChange="addData('.$item->staff_id.',&apos;time_out&apos;,&apos;d7&apos;,&apos;'.$item->d7_date.'&apos;)"';
                                                 ?> id="<?php echo e($item->d7_id == '' ? 'd7_timeOut_'.$item->staff_id:$item->d7_id . '_timeOut'); ?>" class="<?php echo e($item->staff_id); ?>_timeOut6 form-control input-sm" value="<?php echo e($holidayHtml[6] == '' || $item->d7_holidayFlag != 0 ? $item->d7_out : 'N/A'); ?>"   />
                                                <span class="input-group-addon"><i class="fa fa-sign-out"></i></span>
                                            </div><!-- input-group --> 
                                    ...
                                    <div class="theme-panel hidden-xs hidden-sm"  style="right:66px;">
                                        ...
                                        <div class="theme-options4">
                                                ...
                                                <select  id="saturday_months" class="layout-option form-control input-sm">
                                                    ...
                                                    <option><?php echo e($data->monthFilter); ?></option>
                        	...
                        	<table class="table table-striped table-hover table-bordered" id="saturday_timesheet_table">
                                <thead>
                                	<tr style="background:#fff;">
                                        ...
                                        <?php $__currentLoopData = $saturdayDates; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $dates): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?> 
                                            <td class="text-center"> 
                                                <div class="disableSwitchDiv">
                                                    <input type="checkbox" class="make-switch disableSwitch" data-size="small" disabled="disabled">
                                                </div>

                                                <div class="enableSwitchDiv switchHTML_<?php echo e($key); ?>" style="display: none;">
                                                    <input <?php echo e($dates->date > date('Y-m-d') ? "" : 'disabled="disabled"'); ?> value="<?php echo e($dates->date); ?>" type="checkbox" name="enableSwitch1" class="make-switch enableSwitch headerEnableSwitch_<?php echo e($key); ?>" data-size="small" >
                                                </div> 
                                            </td>
                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                    ...
                                    <tr>
                                        ...
                                        $sat_dates = array();
                                         ...
                                         ?>
                                        <?php $__currentLoopData = $saturdayDates; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $dates): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>

                                            <th class="text-center .date_<?php echo e($dates->date); ?>"> <?php  
                                ...
                                <?php $__currentLoopData = $saturdayWeeklyData; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            
                                
                                    <tr> 
                                    	<th width="2%" class="text-center checkboxIndi"> <input type="checkbox" name="" value="<?php echo e($item->staff_id); ?>" class="firstCol"> </th>
                                        <td style="display:none"><?php echo e($item->c_bottomline); ?></td>
                                        <td style="display:none"><?php echo e($item->tt_profile_name); ?></td>
                                        <td style="display:none"><?php echo e($item->campus); ?></td>
            							<td> <strong><?php echo e($item->abridged_name); ?></strong> <br /><small><strong>Dept: <?php echo e($item->c_bottomline); ?></strong></small><br /><small><strong>Desg: <?php echo e($item->c_topline); ?></strong></small><br /><small><strong>Profile: <?php echo e($item->tt_profile_name); ?></strong></small> </td>
     
                                        <?php if(isset($item->d1)): ?> 
                                        <?php if(array_key_exists(0, $sat_dates)): ?>
                                        <td class="text-center " style="vertical-align:middle;">
                                            <input <?php echo e($sat_dates[0] > date('Y-m-d') ? "" : 'disabled="disabled"'); ?> <?php echo e($item->d1 == 0 ? "checked" : ""); ?> value="<?php echo e($sat_dates[0]); ?>_<?php echo e($item->staff_id); ?>"  id="<?php echo e($sat_dates[0]); ?>_<?php echo e($item->staff_id); ?>" type="checkbox" class="make-switch" data-size="small"  name="enableSwitchSingle" >
                                        </td> 
                                        <?php endif; ?>
                                        <?php endif; ?>
                                        <?php if(isset($item->d2)): ?>
                                        <?php if(array_key_exists(1, $sat_dates)): ?>
                                        <td class="text-center " style="vertical-align:middle;">
                                            <input <?php echo e($sat_dates[1] > date('Y-m-d') ? "" : 'disabled="disabled"'); ?> <?php echo e($item->d2 == 0 ? "checked" : ""); ?>  value="<?php echo e($sat_dates[1]); ?>_<?php echo e($item->staff_id); ?>"  id="<?php echo e($sat_dates[1]); ?>_<?php echo e($item->staff_id); ?>"  type="checkbox" class="make-switch" data-size="small"  name="enableSwitchSingle" >
                                        </td> 
                                        <?php endif; ?>
                                        <?php endif; ?>                                        
                                        <?php if(isset($item->d3)): ?>
                                        <?php if(array_key_exists(2, $sat_dates)): ?>
                                        <td class="text-center " style="vertical-align:middle;">
                                            <input <?php echo e($sat_dates[2] > date('Y-m-d') ? "" : 'disabled="disabled"'); ?> <?php echo e($item->d3 == 0 ? "checked" : ""); ?>  value="<?php echo e($sat_dates[2]); ?>_<?php echo e($item->staff_id); ?>" id="<?php echo e($sat_dates[2]); ?>_<?php echo e($item->staff_id); ?>" type="checkbox" class="make-switch" data-size="small"  name="enableSwitchSingle" >
                                        </td> 
                                        <?php endif; ?>
                                        <?php endif; ?> 
                                        <?php if(isset($item->d4)): ?>
                                        <?php if(array_key_exists(3, $sat_dates)): ?>
                                        <td class="text-center " style="vertical-align:middle;">
                                            <input <?php echo e($sat_dates[3] > date('Y-m-d') ? "" : 'disabled="disabled"'); ?> <?php echo e($item->d4 == 0 ? "checked" : ""); ?>  id="<?php echo e($sat_dates[3]); ?>_<?php echo e($item->staff_id); ?>" value="<?php echo e($sat_dates[3]); ?>_<?php echo e($item->staff_id); ?>" type="checkbox" class="make-switch" data-size="small"  name="enableSwitchSingle" >
                                        </td>
                                        <?php endif; ?> 
                                        <?php endif; ?> 
                                        <?php if(isset($item->d5)): ?>
                                        <?php if(array_key_exists(4, $sat_dates)): ?>
                                        <td class="text-center " style="vertical-align:middle;">
                                            <input <?php echo e($sat_dates[4] > date('Y-m-d') ? "" : 'disabled="disabled"'); ?> <?php echo e($item->d5 == 0 ? "checked" : ""); ?>  id="<?php echo e($sat_dates[4]); ?>_<?php echo e($item->staff_id); ?>" value="<?php echo e($sat_dates[4]); ?>_<?php echo e($item->staff_id); ?>" type="checkbox" class="make-switch" data-size="small"  name="enableSwitchSingle" >
                                        </td> 
                                        <?php endif; ?> 
                                        <?php endif; ?>                                                                                 
...
<!-- END USE PROFILE -->
<script src="<?php echo e(URL::to('metronic')); ?>/global/plugins/moment.min.js" type="text/javascript"></script>
<script src="<?php echo e(URL::to('metronic')); ?>/global/plugins/bootstrap-daterangepicker/daterangepicker.min.js" type="text/javascript"></script>
<!--================================================== -->
...
var setSat = function setSat (staff_id, date, state, callback){
    ...
    $.ajax({
        type: "POST",
        url: "<?php echo e(url('/weekly_timesheet/update_weekly_sheet_time_saturday')); ?>",
        data: {
...
$(document).on("click", ".applyMonthFilter", function(){
    ...
    $.ajax({
        type: "GET",
        url: "<?php echo e(url('/weekly_timesheet/get_weekly_sheet_time_saturday')); ?>",
        data: {
            '_token': '<?php echo e(csrf_token()); ?>',
            'date' : date
            },
                    ...
                    loadScript("<?php echo e(URL::to('metronic')); ?>/global/plugins/jquery.sparkline.min.js", function(){
                        loadScript("<?php echo e(URL::to('metronic')); ?>/global/plugins/jqvmap/jqvmap/jquery.vmap.js", function(){
                            loadScript("<?php echo e(URL::to('metronic')); ?>/layouts/layout/scripts/demo.min.js", function(){
								loadScript("<?php echo e(URL::to('metronic')); ?>/global/plugins/bootstrap-switch/js/bootstrap-switch.min.js", function(){
...
*************************************/ ?>
<script src="<?php echo e(URL::to('metronic')); ?>/global/plugins/morris/morris.min.js" type="text/javascript"></script>
<script src="<?php echo e(URL::to('metronic')); ?>/global/plugins/morris/raphael-min.js" type="text/javascript"></script>
<script src="<?php echo e(URL::to('metronic')); ?>/pages/scripts/dashboard.min.js" type="text/javascript"></script>
<script src="<?php echo e(URL::to('metronic')); ?>/global/plugins/spin/spin.js" type="text/javascript"></script>
<script type="text/javascript">
    var pagefunction = function() {
        loadScript("<?php echo e(URL::to('metronic')); ?>/global/scripts/app.min.js", userFormScript);
...
<script type="text/javascript">
    ...
    var updateHolidayFlag= function updateHolidayFlag(id){
        ...
        $.ajax({
            type: "POST",
            url: "<?php echo e(url('/weekly_timesheet/update_weekly_sheet_holidayFlag')); ?>",
            data: {
                '_token': '<?php echo e(csrf_token()); ?>',
                'id' : id,
                'holidayFlag' : 1
    ...
    var updateSaturdayFlag = function updateSaturdayFlag(id){
        ...
        $.ajax({
            type: "POST",
            url: "<?php echo e(url('/weekly_timesheet/update_weekly_sheet_saturday')); ?>",
            data: {
                '_token': '<?php echo e(csrf_token()); ?>',
                'id' : id,
                'saturdayFlag' : 1
    ...
    */
    ...
    var updateData = function updateData(id, type, obj){
        ...
        if(timeIn > timeOut){
            ...
            $.ajax({
                type: "POST",
                url: "<?php echo e(url('/weekly_timesheet/update_weekly_sheet_time')); ?>",
                data: {
                    '_token': '<?php echo e(csrf_token()); ?>',
                    'type' : type, 
                    'id' : id,
    ...
    var addData = function addData(id, type, no,date){
        ...
        if( (timeIn != '' && timeOut != '') && timeIn > timeOut  ){
            ...
            if (timevalidation(timeIn) && timevalidation(timeOut) )  {
                ...
                $.ajax({
                    type: "POST",
                    url: "<?php echo e(url('/weekly_timesheet/add_weekly_sheet_time')); ?>",
                    data: {
                        '_token': '<?php echo e(csrf_token()); ?>',
                        'staff_id' : id, 
                        'date': date,
...
var getData = function getData(){
    ...
    $.ajax({
        type: "POST",
        url: "<?php echo e(url('/weekly_timesheet/get_weekly_sheet_time')); ?>",
        data: {
            '_token': '<?php echo e(csrf_token()); ?>',
            'startDate' : startDate
            },
...
$(function() {
    ...
    $('input[name="daterange"]').daterangepicker({
		...
		var table = jQuery("#saturday_timesheet_table").dataTable({ drawCallback: function(){
            ...
            spinner.stop();
            $('#Generations_AjaxLoader').hide();
            $.getScript( "<?php echo e(URL::to('metronic')); ?>/global/plugins/datatables/fnFilterClear.js");
        }, 8000);
    ...
    var updateAllStaffTime = function updateAllStaffTime( date, col){
        ...
        if(timeIN != '' && timeOUT != ''){
            ...
            $.ajax({
                type: "POST",
                url: "<?php echo e(url('/weekly_timesheet/update_mutiple_staff_weekly_sheet_time')); ?>",
                data: {
                    '_token': '<?php echo e(csrf_token()); ?>',
                    'timeOut' : timeOUT,
                    'timeIn' : timeIN,
