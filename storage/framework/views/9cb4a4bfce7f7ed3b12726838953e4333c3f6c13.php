...
$ConcessionType= $concession_info[0]->ConcessionType;
...
$Installment_6=$concession_info[0]->Installment_6;
$Installment_7=$concession_info[0]->Installment_7;
$Installment_8=$concession_info[0]->Installment_8;
$Installment_9=$concession_info[0]->Installment_9;
$Installment_10=$concession_info[0]->Installment_10;
$Installment_11=$concession_info[0]->Installment_11;
$Installment_12=$concession_info[0]->Installment_12;
...
<div class="form-body">
    ...
    <?php else : ?>
            ...
            <div class="form-group">
                ...
                <select name="concession_type" class="form-control">
                  ...
                  <option value="12" <?php if( $Concession_Type_id == 12){ echo "selected"; } ?> >Differential Concession</option>
                   ...
                   <option value="111" <?php if( $Concession_Type_id == 111){ echo "selected"; } ?> >Scholarship - Academic</option>

                  <option value="122" <?php if( $Concession_Type_id == 122){ echo "selected"; } ?> >Sholarship - Non-Academic</option>
        ...
        <div class="col-md-12">
            <div class="form-group">
                <label class="control-label">Installment #7</label>
                <input type="text" name="Installment_7" class="form-control" placeholder="" value="<?=$Installment_7;?>" />
            </div>
        </div>
        <!--/span-->
        <div class="col-md-12">
            <div class="form-group">
                <label class="control-label">Installment #8</label>
                <input type="text" name="Installment_8" class="form-control" placeholder="" value="<?=$Installment_8;?>" />
            </div>
        </div>
        <!--/span-->
        <div class="col-md-12">
            <div class="form-group">
                <label class="control-label">Installment #9</label>
                <input type="text" name="Installment_9" class="form-control" placeholder="" value="<?=$Installment_9;?>" />
            </div>
        </div>
        <!--/span-->
        <div class="col-md-12">
            <div class="form-group">
                <label class="control-label">Installment #10</label>
                <input type="text" name="Installment_10" class="form-control" placeholder="" value="<?=$Installment_10;?>" />
            </div>
        </div>
        <!--/span-->
        <div class="col-md-12">
            <div class="form-group">
                <label class="control-label">Installment #11</label>
                <input type="text" name="Installment_11" class="form-control" placeholder="" value="<?=$Installment_11;?>" />
            </div>
        </div>
        <!--/span-->
        <div class="col-md-12">
            <div class="form-group">
                <label class="control-label">Installment #12</label>
                <input type="text" name="Installment_12" class="form-control" placeholder="" value="<?=$Installment_12;?>" />
            </div>
        </div>
        <!--/span-->
