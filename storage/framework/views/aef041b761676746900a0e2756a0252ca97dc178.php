 ...
 **************************************************/
?>
<div class="modal fade" id="ChangePasswordNow" tabindex="-1" role="basic" aria-hidden="true">
       ...
       <div class="modal-body" style="float:left;width:100%;">
          <div class="portlet box blue-hoki">
             <div class="portlet-title">
                <div class="caption">
                   <i class="fa fa-user"></i><font id="selected_individuals">Change password</font>
                </div>
                   ...
                   <div id="alert_password_success" class="custom-alerts alert alert-success fade in" style="display: none;"><button type="button" class="close" data-dismiss="alert" aria-hidden="true"></button>Your password has been changed successfully.</div>
                                    ...
                                    <form action="#">
                                        <div class="form-group">
                                            ...
                                            <input id="current_password" type="password" class="form-control" autofocus="true" /> </div>
        ...
        <div class="profile-sidebar">
            ...
            <div class="portlet light profile-sidebar-portlet ">
                ...
                <div class="profile-userpic">
                    <img src="assets/photos/hcm/500x500/staff/gs_logo.png" class="img-responsive" alt=""> </div>
                <!-- END SIDEBAR USERPIC -->
                <!-- SIDEBAR USER TITLE -->
                ...
                <div class="profile-usermenu">
                    <ul class="nav">
                        <li class="active">
                            <a href="#user_profile" id="profileViewButton">
                                <i class="icon-settings"></i> Profile </a>
                        </li>
                        <li>
                            <a class="tooltips" data-placement="bottom" data-original-title="Change password" data-toggle="modal" href="#ChangePasswordNow">
					               ...
					               <div class="tab-pane fade" id="tab_1_3">
					                  <div class="tabbable-line">
					                     <ul class="nav nav-tabs" id="">
					                     	<li class="active">
					                     		<a href="#tab_1_3_7" data-toggle="tab">Monthly Summary</a>
					                     	</li>
					                     	<li>
					                     		<a href="#tab_1_3_8" data-toggle="tab">Daily Breakdown</a>
					                     	</li>
					                     	<li>
					                     		<a href="#tab_1_3_9" data-toggle="tab">Other Adjustments</a>
					                     	</li>
					                     	<?php /* ?>
					                        <li class="active">
					                     ...
					                     <div class="tab-content">
					                     	<div class="tab-pane fade active in" id="tab_1_3_7">
					                          Monthly Summary
					                        </div><!-- tab_1_3_7 -->
					                        <div class="tab-pane" id="tab_1_3_8">
					                          <div class="portlet-body">
					                        ...
					                        <div class="tab-pane" id="tab_1_3_9">
                                    <table class="table-bordered table otherAdjustment">
                                      <thead>
                                        <tr>
                                          <th width="30">
                                            Adjustment Type
                            ...
                            <div class="tab-content">
                                ...
                                <div class="tab-pane active" id="tab_1_1-1">
                                	...
                                	<table width="100%" border="0" class="table-striped table greyBorder">
                                    	<tbody>
                                            <tr>
                                                <td class="col-md-6"><span class="labelHere">Full Name:</span> <strong>Muhammad Faisal</strong></td>
                                                <td class="col-md-6"><span class="labelHere">CNIC:</span> <strong>42101-1624929-5</strong></td>
                                            </tr>
                                            <tr>
                                                <td><span class="labelHere">Name Code:</span> <strong>MHF</strong></td>
                                                <td><span class="labelHere">Gender:</span> <strong>Male</strong></td>
                                            </tr>
                                            <tr>
                                                <td><span class="labelHere">DOB<small> (as per NIC)</small>:</span> <strong>18-November-1980</strong></td>
                                                <td><span class="labelHere">Status:</span> <strong>A-PRB</strong></td>
                                            </tr>
                                   		</tbody>
                                    </table>
                                	...
                                	<table width="100%" border="0" class="table-striped table greyBorder">
                                    	<tbody>
                                            <tr>
                                                <td class="col-md-6"><span class="labelHere">Mobile number:</span> <strong>0300-8276434</strong></td>
                                                <td class="col-md-6"><span class="labelHere">Landline Number:</span> <strong></strong></td>
                                            </tr>
                                            <tr>
                                                <td><span class="labelHere">Email:</span> <strong>m.faisal2@generations.edu.pk</strong></td>
                                                <td></td>
                                            </tr>
                                   		</tbody>
                                    </table>
                                	...
                                	<table width="100%" border="0" class="table-striped table greyBorder">
                                    	<tbody>
                                            <tr>
                                                <td class="col-md-6"><span class="labelHere">Apartment No:</span> <strong></strong></td>
                                                <td class="col-md-6"><span class="labelHere">Street Name:</span> <strong>Block-I</strong></td>
                                            </tr>
                                            <tr>
                                                <td><span class="labelHere">Building Name:</span> <strong></strong></td>
                                                <td><span class="labelHere">Plot No:</span> <strong>C-157/1</strong></td>
                                            </tr>
                                            <tr>
                                                <td><span class="labelHere">Region:</span> <strong>North Nazimabad</strong></td>
                                                <td><span class="labelHere">Sub Region:</span> <strong></strong></td>
                                            </tr>
                                   		</tbody>
                                    </table>
                                </div>
...
// Intaialize Leave Bar Slider      
   var LeaveBar = document.getElementById('LeaveBar');
      ...
      var classes = ['black-color', 'black-color', 'black-color', 'black-color', 'black-color'];
...
for ( var i = 0; i < connect.length; i++ ) {
    ...
    // Payroll Attendance Intializer
	  window.payrollSlider = document.getElementById('PayrollAttendance');
		...
		var staffGtId = "<?php echo $user['info'][0]->gt_id; ?>";
		...
		$.ajax({
         ...
         success:function(result){
          ...
          $('#Table_name').val(Tablename);
            ...
            getStaffOtherAdjustment(staffID);
        },
 ...
 /***** END - Tab Information - TIF-B *****/
  ...
  /************** get_Staff_Other_Adjustment**************************/

  var getStaffOtherAdjustment = function(staffID){
    $.ajax({
      url:"<?php echo e(url('/userProfileController/getOtherAdjustment')); ?>",
      type:"POST",
      cache:true,
      data: {
        staff_id: staffID,
       ...
       success: function (response) {
          ...
          var HtmlOtherAdjustment = '';
          for(var j = 0 ; j < tableData.length ; j++){
            HtmlOtherAdjustment += '<tr class="negativeAdjustment">';
            HtmlOtherAdjustment += '<td>'+tableData[j].adjustment_type+'</td>';
            HtmlOtherAdjustment += '<td>'+tableData[j].date+'</td>';
            HtmlOtherAdjustment += '<td>'+tableData[j].previous_el_balance+'</td>';
            HtmlOtherAdjustment += '<td>'+toFixedTrunc(tableData[j].adjustment,2)+'</td>';
            HtmlOtherAdjustment += '<td>'+tableData[j].new_el_balance+'</td>';
            HtmlOtherAdjustment += '<td>'+tableData[j].register_by+'</td>';
          }
          console.log(HtmlOtherAdjustment);
          $('.otherAdjustment tbody').append(HtmlOtherAdjustment);
       },
       error: function(jqXHR, textStatus, errorThrown) {
           console.log('Something wrong! error: ' + textStatus);
       }
  ...
  // Convert two digit after decimal
  function toFixedTrunc(value, n) {
	...
	var dailyReport = function(date,staffID){
	    $.ajax({
	       ...
	       url:"<?php echo e(url('/masterLayout/getDailyReport')); ?>",
	       success:function(e){
	       ...
	       if(data.length != 0){
	          ...
	          console.log(data);
	           ...
	           // Weekly Time Sheet
                  ...
                  console.log("minutes_wh"+minutes_wh);
	            ...
	            // Factor Mapping
              // console.log('at factor Deduction');
