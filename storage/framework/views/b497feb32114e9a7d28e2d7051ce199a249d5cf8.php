...
<link href="<?php echo e(URL::to('/css/profileAllocation.css')); ?>" rel="stylesheet" type="text/css" />
            ...
            <div class="portlet-body">
                ...
                <div class="table-scrollable table-scrollable-borderless">
                    <table class="table table-hover table-light" id="staffView_Table_StaffList">
                        ...
                        <tr style="display: none;" id="map<?php echo e($data->staff_id); ?>">
                            <td class="fit">
                                <div class="roundedTwo tooltips" style="background:url(<?php echo e($data->photo150); ?>); background-size: contain;" data-container="body" data-placement="top" data-original-title="<?php echo e($data->gt_id); ?>">
                                  <input  disabled="disabled" class="allocationCheckbox" onchange="unmarkCheckbox('roundedTwo_<?php echo e($data->staff_id); ?>', 'roundedTwo<?php echo e($data->staff_id); ?>', <?php echo e($data->staff_id); ?>), updateCount()" type="checkbox" value="<?php echo e($data->staff_id); ?>" id="roundedTwo<?php echo e($data->staff_id); ?>" name="check[]" />
                                  <label for="roundedTwo<?php echo e($data->staff_id); ?>"></label>
                                </div>
                            </td>
                            <td>
                                <a href="javascript:;" class="primary-link tooltips" data-container="body" data-placement="top" data-original-title="<?php echo e($data->tt_profile_name); ?>"></a> <?php echo e($data->abridged_name); ?> - <span class="nameCodeOption tooltips" data-container="body" data-placement="top" data-original-title="<?php echo e($data->atd_title); ?>"><?php echo e($data->name_code); ?></span><br />
                                <small class="shortHeight"> <?php echo e($data->c_topline); ?>, <?php echo e($data->c_bottomline); ?></small>
                            </td>
                            
                             <td class="text-center  staff_<?php echo e($data->staff_id); ?>" colspan="2">
                                    <span class="nameCodeOption tooltips" data-container="body" data-placement="top" data-original-title="<?php echo e($data->tt_profile_name); ?>"><?php echo e(str_limit($data->tt_profile_name , 20)); ?></span>
                                </td>
                                            
                        </tr>
                        <tr class="Row" data-attendance="<?php echo e($data->atd_title); ?>"   data-campus="<?php echo e($data->campus); ?>" data-profile="<?php echo e($data->tt_profile_name); ?>" data-department="<?php echo e($data->c_topline); ?>, <?php echo e($data->c_bottomline); ?>">
                            <td class="fit">
                                <div class="roundedTwo tooltips" style="background:url(<?php echo e($data->photo150); ?>); background-size: contain;" data-container="body" data-placement="top" data-original-title="<?php echo e($data->gt_id); ?>">
                                  <input  onchange="markCheckbox('roundedTwo<?php echo e($data->staff_id); ?>', <?php echo e($data->staff_id); ?> ), updateCount()" type="checkbox" value="<?php echo e($data->staff_id); ?>" id="roundedTwo_<?php echo e($data->staff_id); ?>" name="check[]" />
                                    <label for="roundedTwo_<?php echo e($data->staff_id); ?>"></label>
                                </div>
                            </td>
                            <td>
                                <a onclick="get_tt_profile_time_staff(<?php echo e($data->staff_id); ?>)" href="javascript:;" class="primary-link tooltips profile_StaffName" data-container="body" data-placement="top" data-original-title="<?php echo e($data->atd_title); ?>"><?php echo e($data->abridged_name); ?></a> - <span class="nameCodeOption tooltips" data-container="body" data-placement="top" data-original-title="<?php echo e($data->email); ?>"><?php echo e($data->name_code); ?></span><br />
                                <small class="shortHeight"><?php echo e($data->c_topline); ?></small>
                            </td>
                            <td class="text-center  staff_<?php echo e($data->staff_id); ?>" colspan="2"> 
                                <span class="nameCodeOption tooltips" data-container="body" data-placement="top" data-original-title="<?php echo e($data->tt_profile_name); ?>"><?php echo e(str_limit($data->tt_profile_name , 20)); ?></span>             
                            </td>
                            ...
                            <td class="text-center staff_<?php echo e($data->staff_id); ?>" style="display:none;"> <span aria-hidden="true"></span> <?php echo e($data->tt_profile_name); ?> </td>
...
<script type="text/javascript">
    ...
    */    
    ...
    var get_tt_profile_time = function get_tt_profile_time(obj){
        ...
        if(profile_id !== ""){
            $.ajax({
                url: "<?php echo e(url('/ttprofile_allocation/ttProfileTime_get')); ?>",
                type:"POST",
                cache:true,
    ...
    */      
    var get_tt_profile_time_staff = function get_tt_profile_time_staff(staff_id){
        ...
        $.ajax({
            url: "<?php echo e(url('/ttprofile_allocation/ttProfileTimeStaff_get')); ?>",
            type:"POST",
            cache:true,
    ...
    */
    ...
    var updateProfile = function updateProfile(){
        ...
        if( staff_ids != "" && staff_profile != "Select Profile"){
            ...
            $.ajax({
                url: "<?php echo e(url('/ttprofile_allocation/ttProfile_update')); ?>",
                type:"POST",
                cache:true,
                data: {
                    '_token': '<?php echo e(csrf_token()); ?>',
    ...
    */
    ...
    var postData = function postData(form_id){ 
        ...
        $.ajax({
            url: "<?php echo e(url('/ttprofile_allocation/ttCustomProfile_update')); ?>",
            type:"POST",
            cache:true,
            data: data,
            success: function (response) {
