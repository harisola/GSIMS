                ...
                <div class="table-scrollable table-scrollable-borderless">
                    ...
                    <table class="table table-hover table-light" id="staffView_Table_StaffList">
                        ...
                        <tbody>
                        	...
                        	<tr class="Row" data-grade_section="<?php echo e($student->Section_id); ?>"  data-grade="<?php echo e($student->grade_name); ?>" data-house="<?php echo e($student->house_name); ?>" data-gender="<?php echo e($student->gender); ?>"  >
	                            <td class="fit">
	                                <img class="user-pic rounded tooltips" data-container="body" data-placement="top" data-original-title="GF-ID: <?php echo e($student->gfid); ?>" src="<?php echo e($student->photo150); ?>"> </td>
	                             <td class="studentView_StudentName">
	                                <a href="javascript:;" class="primary-link tooltips" data-container="body" data-placement="top" id="<?php echo e($student->Student_id); ?>_<?php echo e($student->gs_id); ?>" data-original-title="GS-ID: <?php echo e($student->gs_id); ?>"> <?php echo e($student->abridged_name); ?> </a><br>
	                                
	                                 <span class="class_Name BoySta" style="margin-left:10px;">
	                                    <span class="tooltips className" data-container="body" data-placement="top" data-original-title="Class Roll No: <?php echo e($student->class_no); ?>">
	                                    <?php echo e($student->class); ?></span>
	                                    <span class="StuStatus tooltips" data-placement="top" data-original-title="Status: <?php echo e($student->std_status_code); ?>" data-pin-nopin="true">S</span>
										<span class="StuStatus tooltips <?php echo e($student->house_name); ?>" data-placement="top" data-original-title="House: <?php echo e($student->house_name); ?>" data-pin-nopin="true"><?php  echo substr($student->house_name, 0, 1); ?></span>
	                                </span>
	                                
	                            </td>
	                            <td class="text-center">
	                            <!-- //APSA -->
	                            	<?php echo e($student->father_name); ?><br /><small style="color: #000;"><?php echo e($student->gfid); ?></small>
	                            </td>
	                            
	                            <td class="text-center"> 
                                    <a class="tooltips show_addstory_modal" data-placement="top" data-original-title="Add story" data-toggle="modal" href="#" data-id="<?php echo e($student->gs_id); ?>" data-aname="<?php echo e($student->abridged_name); ?>">Add Story</a>
	                            </td>
	                            
	                            <td class="text-center" style="display:none;"><?php echo e($student->call_name); ?></td> <!--// <TD> 14 -->
								<td class="text-center" style="display:none;"><?php echo e($student->grade_name); ?></td> <!--// <TD> 4 -->
								<td class="text-center" style="display:none;"><?php echo e($student->house_name); ?></td> <!--// <TD> 5 -->
								<td class="text-center" style="display:none;"><?php echo e($student->gender); ?></td> <!--// <TD> 6 -->
								<td class="text-center" style="display:none;"><?php echo e($student->gs_id); ?></td> <!--// <TD> 6 -->
			            ...
			            <div class="modal-dialog">
			                <div class="modal-content">
			                    ...
			                    <div class="modal-footer">
			                        ...
			                        <button type="button" class="btn dark btn-outline" data-dismiss="modal">Cancel
                                    </button>
...
<div class="col-md-8 fixed-height" id="StudentView_StuInfo" style="display:;">
        <div class="row">
            <div class="col-md-12 paddingRight0" id="hide_all">
		                        ...
		                        <div class="theme-options4">
                                    ...
                                    <div class="theme-option">
                                        ...
                                        <select id="Sort_By_User" class="layout-option form-control input-sm">
                                           <option value="435">Tehreem Noman (SIS- Relationship Officer)</option>
                                           <option value="2">Farah Shehzad (Relationship Officer (NC)) </option>
                                           <option value="405">Afshan Jalil (Communications Liaison Officer)</option>
                                           <!-- <option value="37">Zulfiqar</option> -->
                                           <option value="231">Salman Munazzam (SIS Campus Liaison (SC))</option>
                                           <option value="34">Ghazanfar Hameed (SIS Campus Liaison (NC))</option>
...
$(document).on("click", ".show_addstory_modal", function (e) {
    ...
    $.get("<?php echo e(url('/student/add_story')); ?>?gs_id="+GSID+"&abridged_name="+aName, function(data) {
...
$('input[name^="Cmm_Cat"]').each(function(i) {
    ...
    $.ajax({
        type:"POST",
        cache:true,
        url:"<?php echo e(url('/student/add_story_db')); ?>",
        data:{
...
$(window).scroll(function() {
    ...
    if($(window).scrollTop() == $(document).height() - $(window).height()) {
            ...
            $.ajax({
                type:"POST",
                cache:true,
                url:"<?php echo e(url('/student/add_more_story')); ?>",
                data:{
    ...
    $('.studentView_StudentName a').click(function(e) {
       ...
       // alert(Student_id)
        ...
        $.ajax({
            type:"POST",
            cache:true,
            url:"<?php echo e(url('/student/Students_Stories')); ?>",
            data:{
...
$(document).on("click", "#Back_To_Main", function(){
	...
	App.startPageLoading();
		...
		type:"POST",
		cache:true,
		url:"<?php echo e(url('/student/Stories_Back')); ?>",
		data:{
			"_token": "<?php echo e(csrf_token()); ?>",
		},
    ...
    */
	...
	$(document).on( "change", "#Multiple_Grade_id", 
		function()
		{
			...
			$.ajax({
				type:"POST",
				url:"<?php echo e(url('/student/Get_Section')); ?>",
				beforeSend: function(){ $("#Waiting_For_Loading").show(); },
				data: { Grade_id:Grade_id, "_token": "<?php echo e(csrf_token()); ?>",  },
				success:function(res){ 
		...
		if( Sort_By_Source != '' ){
			setTimeout(function(){
        		$.ajax({
        			type:"POST",
        			cache:false,
        			url:"<?php echo e(url('/student/filter_story')); ?>",
        			data:{ 
        				stories_limit: 30,
