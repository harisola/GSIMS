...
<?php elseif($approval_data['adjustment_type']=="Exceptional Adjustment"): ?> 
    <tr class="odd gradeX">
        <td style="text-align:center;vertical-align:middle;"><?php echo e($count+1); ?></td>
        <td style="vertical-align:middle;">
            <span class="staffImg"><img class="user-pic rounded tooltips" data-container="body" data-placement="top" data-original-title="18-052" src="assets/photos/hcm/150x150/staff/<?php echo e($approval_data['employee_id']); ?>.png"></span>
...
<?php else: ?>
    ...
    <tr class="odd gradeX">
        ...
        <td class="ExceptionalAdjEvent">
            ...
            <span class="MissedTap">
                <span><strong class="light">Title: </strong><?php echo e($approval_data['type_title']); ?></span><br />
                <?php $approval_dates=explode('///',$approval_data['no_of_days']);
                    ;
                    $from_date=date_create($approval_dates[0]);
                    $from_date=date_format($from_date,"l,M d Y");

                    $to_date=date_create($approval_dates[1]);
                    $to_date=date_format($to_date,"l,M d Y");

                 ?>
                 <?php if($from_date): ?>
                <span><strong class="light">From Date: </strong><?php echo e($from_date); ?></span><br />
                <span><strong class="light">To Date: </strong><?php echo e($to_date); ?></span><br />
                <?php endif; ?>
                <?php if($approval_dates[2]): ?>
                    <span><strong class="light">From Time: </strong><?php echo e(date('h:i:s A', strtotime($approval_dates[2]))); ?></span><br />
                    <span><strong class="light">To Time: </strong><?php echo e(date('h:i:s A', strtotime($approval_dates[3]))); ?></span><br />
                <?php endif; ?>
        ...
        <?php if($approval_data['approval_status']==0): ?>
                <div class="div_<?php echo e($approval_data['effected_table_id']); ?>">
                    <span class="pointer" 
                    onclick="updateLeave(<?php echo e($approval_data['effected_table_id']); ?>,<?php echo e($approval_data['id']); ?>)"
                    
                    href="#"
                    data-toggle="modal" data-target="#LeaveApproval"
                    >Approve</span> 
                    | <span  class="disapprove_btn pointer" 
                            data-Approval_id='<?php echo e($approval_data['effected_table_id']); ?>'
                            data-operation='Exceptional Adjustments'
