    ...
    <tr class="odd gradeX">
        ...
        <td class="ExceptionalAdjEvent">
            ...
            <span class="MissedTap">
                ...
                <span><strong class="light">Entry by: </strong><span class="tooltips" data-container="body" data-placement="top" data-original-title="Hassan Ahmed Khan"><?php echo e($approval_data['enter_by']); ?></span></span><br />
                <span><strong class="light">Added on: </strong><?php echo e($approval_data['date_format']); ?>, at <?php echo e($approval_data['time']); ?></span><br />
