    <table class="table table-striped table-bordered table-hover order-column dataTable no-footer" id="DetailsIssuanceBillReport">
        ...
        <?php $i=1; ?>
        <?php $__currentLoopData = $issuance_reports; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $issuance_report): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
               <?php 
                ...
                ?>
            <tr>
                <td  width="100"><?php echo e($i++); ?></td>
                <td><?php echo e($issuance_report->student_gs_id); ?></td>
                <td><?php echo e($issuance_report->gfid); ?></td>
                <td><?php echo e($issuance_report->std_status_code); ?></td>
                <td><?php echo e($issuance_report->grade_dname); ?></td>
                <td><?php echo e($issuance_report->student_name); ?></td>
                <td><?php echo e($issuance_report->bill_title); ?></td>
                <td><?php echo e($issuance_report->gb_id_mc_a); ?></td>
                ...
                <td><?php echo e($issuance_report->oc_yearly); ?></td>
                <td><?php echo e($issuance_report->oc_smartcard_charges); ?></td>
                <td><?= number_format($issuance_report->adjustment)?></td>
                <td></td>
                <td><?php echo e($issuance_report->roll_over_charges); ?></td>
