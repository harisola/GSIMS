...
<div class="row marginTop20">
  ...
  <?php echo $__env->make('master_layout/staff/staff_recruitment/staff_recruitment_initiation_staff_list_archive', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
...
$('#followupCommentsErrorDiv').show();
  ...
  $('#followupCommentsErrorDiv').hide();
    ...
    $.ajax({
        ...
        url:"<?php echo e(url('/update_archieve')); ?>",
        dataType: "json",
...
function ReloadTableDataServerSide2()
  {
    ...
    var dt = $('#new_table').dataTable({
          ...
          'language': { search: "" },
          'ajax': {
              "url": "<?php echo e(url('/modified_form_archive')); ?>", 
               "dataType": "json",
               "type": "POST",
               "data":{
          '_token': '<?php echo e(csrf_token()); ?>', 
...
function getLogs(Form_id){
 ...
 // $(".logsArea").show();
    ...
    $.ajax({
      type:'POST',
      data:{ '_token': '<?php echo e(csrf_token()); ?>', "Form_id":Form_id },
      url:"<?php echo e(url('/archiveLogs')); ?>",
      dataType: "json",
      success: function(response)
      {
        $("#process_detail").show();
