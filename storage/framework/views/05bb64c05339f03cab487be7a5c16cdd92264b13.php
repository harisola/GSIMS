 ...
 $("#staffView_StaffList_Search").keyup(function(){
	...
	var ReloadTableDataServerSide = function()
	{
		...
		var dt = $('#empTable').dataTable({
		      ...
		      'language': { search: "" },
		      'ajax': {
		          "url": "<?php echo e(url('/modified_form_list')); ?>", 
		           "dataType": "json",
		           "type": "POST",
		           "data":{
...
function ReloadTableData()
{
	...
	$("#StaffList").DataTable().destroy();
			...
			setTimeout(function(){ 
				...
				$.ajax({
					type:'POST',
					data:{'_token': '<?php echo e(csrf_token()); ?>', 'pathname':pathname },
		...
		function()
		{
			...
			if( parseInt( form_id ) > 0 )
			{
				$.ajax({
					type:'POST',
					data:{
						'_token': '<?php echo e(csrf_token()); ?>', "form_id":form_id, "status_id":status_id,"stage_id":stage_id
						

						},
					url:"<?php echo e(url('/call_for_part_b_presence')); ?>",
					dataType: "json",
					success: function(response)
					{
				...
				$.ajax({
					type:'POST',
					data:{ '_token': '<?php echo e(csrf_token()); ?>', "form_id":form_id, "status_id":status_id,"stage_id":stage_id,"taging":taging },
					url:"<?php echo e(url('/addFormDataMoveToArchive')); ?>",
					dataType: "json",
					success: function(response)
					{
