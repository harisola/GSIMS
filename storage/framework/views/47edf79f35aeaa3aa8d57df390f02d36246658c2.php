...
<div class="row marginTop20">
    <div class="col-md-5 borderRightDashed">
        ...
        <div class="portlet light bordered fixed-height marginBottom0 padding0 fixed-height-NoScroll">
        	<?php if( $AllSchool != '' ) { ?>
                <h2 class="allSchoolClass">Browse Students</h2>
            <?php } else { ?> 
			...
			<input type="hidden" name="Current_user_photo" id="Current_user_photo" value="<?php echo e($User_photo_id); ?>" />
			<input type="hidden" name="User_abridged_name" id="User_abridged_name" value="<?php echo e($User_abridged_name); ?>" />
            ...
            <div class="portlet-title">
                <div class="caption caption-md col-md-12 padding0">
                    ...
                    <div class="col-md-3 padding0" style="border-right:1px solid #dcdcdc;">
                        <h4 class="text-center totalAtt AttHead">
                            <span class="tooltips font-blue-sharp" data-toggle="tooltip" data-placement="bottom" data-original-title="Total" data-pin-nopin="true"><?php echo $Grade_Grade_Total3; ?></span>
                            <span class="grayish smallTop tooltips" data-toggle="tooltip" data-placement="bottom" data-original-title="Fence" data-pin-nopin="true">+<?php echo $Fence_Total; ?></span>    
                        </h4>
                        <div class="col-md-12 padding0" style="color: #888;padding-top: 10px !important;">
                            ...
                            <div class="col-md-6 text-center tooltips" data-toggle="tooltip" data-placement="bottom" data-original-title="Present score" data-pin-nopin="true" style="width:49%;font-size:14px;">
                                <?php echo $Percentage_Today_Total; ?>%
                            </div>
                        </div>
                        ...
                        <div class="col-md-12 padding0" style="padding-top: 10px !important;color: #888;">
                            ...
                            <?php echo $Percentage_Today_Total_Absent; ?>%
                            </div>
                        </div><!-- 
					...
					<?php } ?>	
					 ...
					 <?=$ClassTitle;?> &nbsp; 
                        ...
                        <div class="col-md-3 padding0">
                            <img src="<?php echo $Tchrs['TOneImage']; ?>" width="45" class="marginRight10 maringBottom0 circleImg" style="border:1px solid #888;">
                        </div><!-- -->
                        <div class="col-md-6 padding0">
                            <h5 class="marginBottom0 text-left marginTop0" ><?php echo $Tchrs['TOneName']; ?></h5>
                            <span class="onlyBorder">&nbsp;</span>
                            <h5 class="marginBottom0 text-right" style=""><?php echo $Tchrs['TTwoName']; ?></h5>
                        </div><!-- -->
                        <div class="col-md-3 padding0">
                            <img src="<?php echo $Tchrs['TTwoImage']; ?>" width="45" class="marginRight10 maringBottom0 circleImg" style="border:1px solid #888;">
                        </div><!-- -->
                    </div><!-- -->
                    ...
                    <div class="col-md-3 padding0" style="border-left:1px solid #dcdcdc;">
                        ...
                        <h4 class="text-center todayAttScore AttHead">
                            <span class="tooltips" data-placement="bottom" data-original-title="Today's score" data-pin-nopin="true"><?php echo $Today_Score; ?></span>                    
                        </h4>
                    ...
                    <div class="theme-panel hidden-xs hidden-sm"  style="right:33px;">
                        ...
                        <div class="theme-options">
                            <div class="theme-option">
                                <span> Grade </span>
                                <select data-attribute="grade" id="StaffView_Filter_Profile" class="ddlFilterTableRow layout-option form-control input-sm">
                                    
                                </select>
                            </div>
                            <div class="theme-option">
                                <span> Status </span>
                                <select data-attribute="status" id="StaffView_Filter_Department" class="ddlFilterTableRow layout-option form-control input-sm">
                                    
                                </select>
                            </div>
                            <div class="theme-option">
                                <span> Gender </span>
                                <select data-attribute="gender" id="StaffView_Filter_Campus" class="ddlFilterTableRow page-header-option form-control input-sm">
                            ...
                            <div class="theme-option">
                                <span> Badges </span>
                                <select data-attribute="badges" id="StaffView_Filter_AtdStd" class="ddlFilterTableRow page-header-option form-control input-sm">
                            ...
                            <div class="theme-option">
                                <span> House </span>
                                <select data-attribute="house" id="StaffView_Filter_Campus_House" class="ddlFilterTableRow page-header-option form-control input-sm">
                        ...
                        <tr    >
                            <td class="fit">
                             ...
                             <td class="studentView_StudentName">
                                <a href="javascript:;" class="primary-link tooltips" data-container="body" data-placement="top" id="<?php echo $Student->Student_Id; ?>_<?php echo $Student->GS_ID; ?>" data-original-title="GS-ID: <?php echo $Student->GS_ID; ?>"> <?=$Student->Abridged_Name;?> </a><br />
                            ...
                            <!-- Badges-->
                                ...
                                $Badges = app(App\Http\Controllers\Student_Information\Master_Page\Grade::class)->Student_Badges($Student->Student_Id)
                                 ?> 
                                <?php if(!empty( $Badges ) ): ?>
                                    <?php $__currentLoopData = $Badges; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $SB): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <p style="display:none;"><?php echo $SB->Bdg_Title; ?></p>
                                        <span class="badgeTeacher tooltips" data-placement="top" data-original-title="<?php echo $SB->Bdg_Title; ?>" data-pin-nopin="true" style="border-color:<?php echo $SB->Badge_Color; ?>;color:<?php echo $SB->Badge_Color; ?>" ><?php echo $SB->Badge_code; ?></span>
                            ...
                            ?>
                                ...
                                <!-- Attendance -->
                                <span class="tenDayAttStatuss tooltips" data-container="body" data-placement="top" data-original-title="10 day status"><?php echo $Student->total_pf;; ?></span>
                                <span class="sixtyDayAttStatuss tooltips" data-container="body" data-placement="top" data-original-title="60 day status"><?php echo $Student->total_ps;; ?></span>
                                </span>
                            </td>
                            
                            
                            <td class="text-center" style="display:none;"><?php echo $Student->Statud_Code;; ?></td> <!--// <TD> 7 -->
                            <td class="text-center" style="display:none;"><?php echo $Student->House;; ?></td> <!--// <TD> 8 -->
                            <td class="text-center" style="display:none;"><?php echo $Student->Student_Id;; ?></td> <!--// <TD> 9 -->
                            <td class="text-center" style="display:none;"><?php echo $Student->GS_ID;; ?></td> <!--// <TD> 10 -->
                            <td class="text-center" style="display:none;"><?php echo $Student->Grade_Name;; ?></td> <!--// <TD> 11 -->
                            <td class="text-center" style="display:none;"><?php echo $Student->Section_Name;; ?></td> <!--// <TD> 12 -->
                            <td class="text-center" style="display:none;"><?php echo $Student->GF_ID;; ?></td> <!--// <TD> 13 -->
                            <td class="text-center" style="display:none;"><?php echo $Student->C_Name;; ?></td> <!--// <TD> 14 -->
                            <td class="text-center" style="display:none;"><?php echo $Student->Gender;; ?></td> <!--// <TD> 15 -->
                            <td class="text-center" style="display:none;"><?php echo $Student->total_pf;; ?></td> <!--// <TD> 16 -->
                            <td class="text-center" style="display:none;"><?php echo $Student->O_Name;; ?></td> <!--// <TD> 6 -->
...
<button type="button" class="btn dark btn-outline" data-dismiss="modal">Close</button>
        ...
        <div class="modal fade" id="Add_New_Badge_Form_modal" tabindex="-1" role="Add_New_Badge_Form_modal" aria-hidden="true">
            <div class="modal-dialog">
            <!--form id="Form_Badges" class="form-horizontal" action="<?php echo url('/student/create/badge'); ?>"name="Form_Badges" method="post" -->
                                        ...
                                        <div class="rightpullAbsolutes">
                                            <div class="pull-right commentType" id="commentType">
                                                ...
                                                <div class="dropdown-menuu pull-right" role="menu" style="display:none;">
													...
													<?php if( !empty( $CommCat) ): ?>
														<?php foreach( $CommCat as $Cat ): ?>
														<label class="mt-checkbox">
                                                        <input type="checkbox" name="CheckBox_<?=$Cat->Category_name;?>" id="CheckBox_<?=$Cat->Category_name;?>" value="CheckBox_<?=$Cat->Category_name;?>" class="CheckBox_Category" /> 
														<?php 
        ...
        form2.validate({
            ...
            rules: {
                ...
                submitHandler: function (form,element) {
                    ...
                    $.ajax({
                        type:"POST",
                        url:"<?php echo e(url('/student/create/badge')); ?>",
                        beforeSend: function(){ },
                        data: $form.serialize(),
                        dataType: "JSON",
                        success:function(result){
    ...
    $('.studentView_StudentName a').click(function(e) {
       ...
       // alert(Student_id)
        ...
        $.ajax({
            type:"POST",
            cache:true,
            url:"<?php echo e(url('/student/detail')); ?>",
            data:{
...
$.ajax({
	type: "POST",
	cache:true,
	url:"<?php echo e(url('/student/show_fif')); ?>",
	data:{
		Gs_id:Family_id,
		"_token": "<?php echo e(csrf_token()); ?>",
	},
 ...
 $('#btn_Add_Comments').click(function(e) {
	...
	if( ( Search_Area != '' ) && ( arrType.length > 0 ) && (indFam.length >0) ){
		...
		html +='<img class="avatar" alt="" src="<?php echo e(STAFF_PIC_150); ?>'+Current_user_photo+'<?php echo e(STAFF_PIC150_TYPE); ?>" />';
	...
	setTimeout(function(){ App.stopPageLoading(); },3000);
		$.ajax({
			type: "POST",
			cache:true,
			url:"<?php echo e(url('/student/post_comments')); ?>",
			data:{
...
$(document).on("click", ".Edit_Badge", function(){
	...
	$.ajax({
		type:"POST",
		url:"<?php echo e(url('/student/create/edit_badge')); ?>",
		beforeSend: function(){ $("#Waiting_For_Loading").show(); },
		data: { Badge_Id:Badge_Id, "_token": "<?php echo e(csrf_token()); ?>",  },
		dataType: "HTML",
...
$(document).on("click", ".Revert_Back", function(){
        ...
        form2.validate({
            ...
            rules: {
                ...
                submitHandler: function (form,element) {
                    ...
                    $.ajax({
                        type:"POST",
                        url:"<?php echo e(url('/student/create/edit_badge_form')); ?>",
                        beforeSend: function(){ },
                        data: $form.serialize(),
                        dataType: "JSON",
                        success:function(result){
    ...
    /*function refreshStudentList()
    {
        ...
        type:"POST",
        cache:true,
        url:"<?php echo e(url('/student/create/list_refresh')); ?>",
...
if( category== 'SIS' ||  category== 'Etab' || category== 'Accounts' || category== 'Academic' ){ $(this).show(); }else{ $(this).hide();}
	...
	$('#staffView_search_btn33 .applySearch').click(function() {
		...
		$.ajax({
			type:"POST",
			cache:true,
			url:"<?php echo e(url('/student/search_comments')); ?>",
			data:{ 
            ...
            loadScript("<?php echo e(URL::to('metronic')); ?>/pages/scripts/profile.js", function(){
                ...
                loadScript("<?php echo e(URL::to('metronic')); ?>/pages/scripts/table-datatables-managed.js", function(){
					...
					loadScript("<?php echo e(URL::to('metronic')); ?>/global/plugins/bootstrap-toastr/toastr.min.js", function(){	
                            ...
                            loadScript("<?php echo e(URL::to('metronic')); ?>/pages/scripts/form-validation.min.js", function(){
							loadScript("<?php echo e(URL::to('metronic')); ?>/pages/scripts/ui-toastr.min.js", function(){
