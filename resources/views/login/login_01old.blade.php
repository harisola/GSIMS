...
<html lang="en">
    ...
    <head>
        ...
        <link href="{{ URL::to('metronic') }}/pages/css/login.min.css" rel="stylesheet" type="text/css" />
    ...
    <body class=" login">
        ...
        <div class="logo">
            <a href="index.html">
                <img src="{{ URL::to('metronic') }}/pages/img/GSLogo-W.png" alt="" /> </a>
        </div>
        <!-- END LOGO -->
        <!-- BEGIN LOGIN -->
        <div class="content">
...
<![endif]-->
        ...
        <!-- END CORE PLUGINS -->
        <!-- BEGIN PAGE LEVEL PLUGINS -->
        <script src="{{ URL::to('metronic') }}/global/plugins/jquery-validation/js/jquery.validate.min.js" type="text/javascript"></script>
        <script src="{{ URL::to('metronic') }}/global/plugins/jquery-validation/js/additional-methods.min.js" type="text/javascript"></script>
        <script src="{{ URL::to('metronic') }}/global/plugins/select2/js/select2.full.min.js" type="text/javascript"></script>
        <!-- END PAGE LEVEL PLUGINS -->
        <!-- BEGIN THEME GLOBAL SCRIPTS -->
        <script src="{{ URL::to('metronic') }}/global/scripts/app.min.js" type="text/javascript"></script>
        <!-- END THEME GLOBAL SCRIPTS -->
        <!-- BEGIN PAGE LEVEL SCRIPTS -->
        <script src="{{ URL::to('metronic') }}/pages/scripts/login.min.js" type="text/javascript"></script>
        ...
        <script type="text/javascript">
            $(document).ready(function() {
                ...
                $('#socialLogin a').click(function() {
                    window.location = "{{ url('/login/google') }}";
                });
            });
        </script>
    </body>
