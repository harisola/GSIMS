		...
		<div class="col-md-6 paddingBottom10">
			<!-- form-group -->
			   <div class="form-group">
				  ...
				  <div class="">
						<input type="text" class="form-control form_part_a" name="form_number_absentia_a" id="form_number_absentia_a" value="{{$format_code}}" disabled="" />
						<input type="text" class="form-control form_part_b" name="form_number_absentia_b" id="form_number_absentia_b" value="{{$form_number[1]}}" />
				  </div>
			   </div>
			   <!-- form-group -->
		   <div class="form-group">
