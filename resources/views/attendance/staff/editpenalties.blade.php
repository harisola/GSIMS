<?php 
	 ...
	 @$form_number=explode($format_code, $data[0]->form_number);
 ?>
<div class="row">
	<div class="col-md-6 paddingBottom10">
		<div class="form-group">
		  ...
		  <div class="">
				<input type="text" class="form-control form_part_a" name="form_number_penalty_a" id="form_number_penalty_a" value="{{@$format_code}}" disabled="" />
				<input type="text" class="form-control form_part_b" name="form_number_penalty_b" id="form_number_penalty_b" value="{{@$form_number[1]}}" />
		  </div>
	   </div>
	   <div class="form-group">
