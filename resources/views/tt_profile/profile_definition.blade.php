...
<!--                                                 <option value="standardProfile" data-profileDefination-type="1">Standard</option>
                                                ...
                                                @foreach ($profile_type as $profile_type)
                                                    <option value="{{ $profile_type->javascript_displayToggle }}" data-profileDefination-type="{{$profile_type->id}}">{{ $profile_type->name }}</option>
                                                @endforeach
    ...
    function insertProfile(profile_type_id){
      ...
      /***** Further Requests of AJAX *****/
        ...
        $.ajax({
            type:"POST",
            cache:false,
            url:"{{url('/profileDefination/insertProfile')}}",
            data:{
     ...
     // var relaxtion_time = $('#relaxation_time_std').val();
      ...
      /***** Further Requests of AJAX *****/
        ...
        $.ajax({
            type:"POST",
            cache:false,
            url:"{{url('/profileDefination/insertStandardProfile')}}",
            data:{
  ...
  profile_id:profile_id,
    ...
    function PartTimerTimeInsert(profile_id){
        ...
        $.ajax({
            ...
            type:"POST",
            cache:false,
            url:"{{url('/profileDefination/insertPartTimerProfile')}}",
            data:{
                profile_id:profile_id,
                mon_in:mon_in,
                mon_out:mon_out,
      ...
      $(document).on('click','.staffDefination_profile_id',function(){
       ...
       // $('.add_profile_label').css('display','none');
        ...
        $.ajax({
            type:"POST",
            cache:false,
            url:"{{url('/profileDefination/profile_description')}}",
            data:{
                profile_id:profile_id,
                "_token":"{{csrf_token()}}",
            },
      ...
      var ext_frequency = $('#ext_frequency_update').val();
       ...
       if(morning_time.length != 0 && afternoon_time.length != 0){
        ...
        $('#mon_thurs_hours').text(difference_mt);
          ...
          //console.log('counter_mon_thu_min'+)
    ...
    function UpdationDataCustom(profile_obj){
        ...
        if(profile_obj[0]['is_on_mon'] == 1){
            ...
            $('#custom_afternoon_udpate').val(profile_obj[0]['thu_out']);
        }else{
    ...
    function customCalculation(){
          ...
          difference_f = new Date(new Date(p+custom_friday) - new Date(p+custom_morning)).toUTCString().split(" ")[4];
            ...
            $('#cus_mon_thu_hrs').text(difference_mt);
            $('#counter_mon_thu_hrs').text(difference_mt.split(":")[0]);
    ...
    function updateProfile(profile_id,profile_type_id){
      ...
      /***** Further Requests of AJAX *****/
        ...
        $.ajax({
            type:"POST",
            cache:false,
            url:"{{url('/profileDefination/updateProfile')}}",
            data:{
                profile_name:profile_name,
                profile_type_id:profile_type_id,
                profile_id:profile_id,
    ...
    function updateStandardProfile(profile_id){
        ...
        $.ajax({
            type:"POST",
            cache:false,
            url:"{{url('/profileDefination/updateStandardProfile')}}",
            data:{
                profile_id:profile_id,
                morning_time:morning_time,
                afternoon_time:afternoon_time,
    ...
    function updateCustomProfile(profile_id){
        ...
        $.ajax({
            type:"POST",
            cache:false,
            url:"{{url('/profileDefination/updateCustomProfile')}}",
            data:{
                profile_id:profile_id,
                morning_time:morning_time,
                afternoon_time:afternoon_time,
    ...
    function updatePartTimeProfile(profile_id){
        ...
        $.ajax({
            type:"POST",
            cache:false,
            url:"{{url('/profileDefination/updatePartTimerProfile')}}",
            data:{
                profile_id:profile_id,
                mon_in:mon_in,
                mon_out:mon_out,
  ...
  // Custom Profile Update
    ...
    function staffProfileAllocated(){
        $.ajax({
            type:"post",
            cache:false,
            url:"{{url('/profileDefination/staffProfileAllocated')}}",
            data:{
                "_token":"{{csrf_token()}}"
            },
            success:function(e){
