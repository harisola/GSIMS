                ...
                <?php $super_flag = 0; ?>
                    ...
                    <?php $super_flag = 1 ?>
                          ...
                          <?php } ?>
                              ...
                              <?php if($super_flag == 0) { ?>
                              <td>
                               <a href="javascript:void(0)"  class="MonINInsert" data-placement="bottom" data-title="Morning" data-profile_id ="<?php echo $profile->id ?>" data-super_profile="<?php echo $super->ID ?>" data-pk="1" data-type="combodate">00:00:00
                              </a> &nbsp; - &nbsp; <a href="javascript:void(0)"  class="MonOUTInsert" data-placement="bottom" data-title="Afternoon" data-profile_id ="<?php echo $profile->id ?>" data-super_profile="<?php echo $super->ID ?>" data-pk="1" data-type="combodate"> 00:00:00
                               </a>
                              </td>
                              <?php } ?>
