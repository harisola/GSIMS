...
<div class="row marginTop20">
    <div class="col-md-12" id="" style="">
        <div class="row">
            <div class="col-md-12 paddingRight0 fixed-height">
                <div class="portlet light forced bordered padding0 marginBottom0">
                    <div class="portlet-title">
                        ...
                        <div class="tools"><input type="button" class="btn green" onclick="myFunction()" value="Filter" /></div>
                    </div><!-- portlet-title -->
                    <div class="row customRow" id="myDIV" style="display: none;">
                      <div class="col-md-3">
                          <label>Date From</label>
                          <input type="date" class="form-control" value="" id="date1">
                      </div>
                      <div class="col-md-3">
                          <label>Date To</label>
                          <input type="date" class="form-control" value="" id="date2">
                      </div>
                      <div class="col-md-3">
                          ...
                          <select id="subjectFilter" multiple="multiple">
                             <?php
                                foreach ($all_subjects as $all_subject) {
                                 ?>
                                    <option value="<?php echo $all_subject->name; ?>"><?php echo $all_subject->name; ?></option>
                                <?php
                                 }
                                ?>
                          </select>
                      ...
                      <div class="col-md-3" style="margin-top: 30px;">
                          ...
                          <select id="campusFilter" multiple="multiple">
                              <option data-grade_id=""  value="1">South</option>
                              <option data-grade_id="" value="2">North</option>
                          </select>
                      </div>
                      <div class="col-md-3" style="margin-top: 30px;">
                          <label>Form Source</label>
                          <select id="formSourceFilter" multiple="multiple">
                              <option data-grade_id="" value="0">Walkin</option>
                              <option data-grade_id=""  value="1">Online</option>
                            
                          </select>
                      </div>
                      <div class="col-md-3" style="margin-top: 30px;">
                          <label>&nbsp;</label>
                          <input type="button"  id="filter_report" data-re_generate="0" class="btn btn-group green filter_report" value="Filter Processflow" style="width: 100%;">
                      </div>
                    </div><!-- cutomRow -->
              <div class="row marginTop20">
  ...
  <div class="col-md-12" id="main_div" style="overflow-y: hidden;position:relative; "> 
    <img src="img/RecruitmentProcessflow.jpg" width="3500" />
      <div class="startTillCSL3">
          ...
          */ ?>
          ...
          <span class="FullFormScreening absolute">
              <a href="#allocateProfileModal" data-toggle="modal" data-status="Applicants_moved_to" class="tooltips counter" data-container="body" data-placement="top" data-original-title="Applicants moved to Fill Form Screening">{!! $num_235 !!}</a> 
      ...
      <div class="CSL3TillDDM3">          
        ...
        <span class="FormalInterviewFollowupNotInterested absolute">
         <!--  //cahnge Not_Interested// -->
            <a href="#allocateProfileModal" data-toggle="modal" data-status="Not_Interested_formal" class="tooltips gray counter" data-container="body" data-placement="top" data-original-title="Overall applicants moved to Not Interested from Followup for Formal Interview presence">{!! $num_26 !!}</a>
        ...
        </span><!-- FormalInterviewCommunicationNotInterested {!! $num_27 !!} -->
        <!-------------------------------------------------------------------------------------------------------------------------------- -->
      ...
      <div class="DDM3TillEnd">
              ...
              <span class="OverallOfferPrepAllocation absolute">
                  <a href="#allocateProfileModal" data-toggle="modal" data-status="Overall_Offer_Prep_Allocation" class="tooltips gray counter" data-container="body" data-placement="top" data-original-title="Applicants moved to Offer Preparation from Final Consultation">{!! $num_49_1 !!}</a>
              ...
              <span class="OfferPrepAllocation absolute">
                  <a href="#allocateProfileModal" data-toggle="modal" data-status="Offer_Prep_Allocation" class="tooltips counter" data-container="body" data-placement="top" data-original-title="Applicants moved to Offer Preparation from Final Consultation Allocation">{!! $num_49 !!}</a>
              ...
              <span class="OfferProcCommunication absolute">
                  <a href="#allocateProfileModal" data-toggle="modal" data-status="Offer_Proc_Communication" class="tooltips counter" data-container="body" data-placement="top" data-original-title="Applicants moved to Offer Procedure Communication from Offer Prep Allocation">{!! $num_50 !!}</a>
              ...
              <span class="OfferProcPresence absolute">
                  <a href="#allocateProfileModal" data-toggle="modal" data-status="Offer_Proc_Presence" class="tooltips gray counter" data-container="body" data-placement="top" data-original-title="Overall applicants marked Present for Offer Procedure">{!! $num_50_1 !!}</a>
              ...
              <span class="OverallOfferProcFollowup absolute">
                  <a href="#allocateProfileModal" data-toggle="modal" data-status="Overall_Offer_Proc_Followup" class="tooltips gray counter" data-container="body" data-placement="top" data-original-title="Overall applicants moved to Followup for Offer Procedure ">{!! $num_50_2 !!}</a>
              ...
              <span class="ApplicantsInOfferProcFollowup absolute">
                  <a href="#allocateProfileModal" data-toggle="modal" data-status="Applicants_InOffer_Proc_Followup" class="tooltips counter" data-container="body" data-placement="top" data-original-title="Applicants currently in Followup for Offer Procedure Presence">{!! $num_50_5_1 !!}</a>
                  <span class="noFollow tooltips" data-original-title="7 Days passed no action taken">({!! $num_50_5_2 !!})</span>
              ...
              <span class="OverallOfferProcFollwupExtensions absolute">
                  <a href="#allocateProfileModal" data-toggle="modal" data-status="Overall_Offer_Proc_Follwup_Extensions" class="tooltips gray counter" data-container="body" data-placement="top" data-original-title="Overall applicants moved to Extension from Followup for Offer Procedure">{!! $num_50_3 !!}</a>
              ...
              <span class="OverallOfferProcNotInterested absolute">
                  <a href="#allocateProfileModal" data-toggle="modal" data-status="Overall_Offer_Proc_Not_Interested" class="tooltips gray counter" data-container="body" data-placement="top" data-original-title="Overall applicants moved to Not interested from Followup for Offer Procedure ">{!! $num_50_4 !!}</a>
              </span><!-- OverallOfferProcNotInterested  -->
              <!-- -->
              <!-- ApplicantInOfferProcedure: Applicants currently in Offer Procedure {!! $num_51 !!} -->
              <span class="ApplicantInOfferProcedure absolute">
                  <a href="#allocateProfileModal" data-toggle="modal" data-status="Applicant_InOffer_Procedure" class="tooltips counter" data-container="body" data-placement="top" data-original-title="Applicants currently in Offer Procedure from Offer preparation">{!! $num_49_2 !!}</a>
              ...
              <span class="OverallApplicanttoCompChecklist absolute">
                  <a href="#allocateProfileModal" data-toggle="modal" data-status="Overall_Applicantto_Comp_Checklist" class="tooltips gray counter" data-container="body" data-placement="top" data-original-title="Overall applicants moved to Complete Checklist from Offer Procedure ">{!! $num_51_1 !!}</a>
              ...
              <span class="ApplicantsInCompChecklist absolute">
                  <a href="#allocateProfileModal" data-toggle="modal" data-status="Applicants_In_Comp_Checklist" class="tooltips counter" data-container="body" data-placement="top" data-original-title="Applicants Currently in Complete Checklist ">{!! $num_52 !!}</a>
              ...
              <span class="OverallApplicantsCompChecklistFollowup absolute">
                  <a href="#allocateProfileModal" data-toggle="modal" data-status="Overall_Applicants_Comp_Checklist_Followup" class="tooltips gray counter" data-container="body" data-placement="top" data-original-title="Overall applicants moved to Followup For Complete Checklist">{!! $num_52_1 !!}</a>
              ...
              <span class="OverallApplicantsNotInterestedFromCompChecklistFollowup absolute">
                  <a href="#allocateProfileModal" data-toggle="modal" data-status="Overall_Applicants_Not_Interested_From_Comp_Checklist_Followup" class="tooltips gray counter" data-container="body" data-placement="top" data-original-title="Overall applicants moved to Not Interested from Followup For Complete Checklist ">{!! $num_53_2 !!}</a>
              ...
              <span class="OverallApplicantsExtensionFromCompChecklistFollowup absolute">
                  <a href="#allocateProfileModal" data-toggle="modal" data-status="Overall_Applicants_Extension_From_Comp_Checklist_Followup" class="tooltips gray counter" data-container="body" data-placement="top" data-original-title="Overall applicants moved to Extension from Followup For Complete Checklist ">{!! $num_53_1 !!}</a>
              </span><!-- OverallApplicantsExtensionFromCompChecklistFollowup  -->
              <!-- -->
              <!-- OverallApplicantsExtensionFromCompChecklistFollowup: Overall applicants moved to Extension from Followup For Complete Checklist -->
              <span class="ApplicantsRecruitmentComplete absolute">
                  <a href="#allocateProfileModal" data-toggle="modal" data-status="Applicants_Recruitment_Complete" class="tooltips counter" data-container="body" data-placement="top" data-original-title="Applicant Recruitment Complete ">{!! $num_53 !!}</a>
              ...
              <span class="OverallApplicantsAborted absolute">
                  <a href="#allocateProfileModal" data-toggle="modal" data-status="Overall_Applicants_Aborted" class="tooltips gray counter" data-container="body" data-placement="top" data-original-title="Overall applicants Aborted/not Interested">{!! $num_4_5+$num_18+$num_17+$num_27+$num_26+$num_37+$num_46+$num_50_4+$num_53_2 !!}</a>
              ...
              <span class="OverallApplicantsRegretted absolute">
                  <a href="#allocateProfileModal" data-toggle="modal" data-status="Overall_Applicants_Regretted" class="tooltips gray counter" data-container="body" data-placement="top" data-original-title="Overall applicants Regretted">{!! $num_10+$num_30+$num_29+$num_38+$num_47 !!}</a>
              </span><!-- OverallApplicantsRegretted  -->
              
              <!-- ApplicantArchive: Applicants in Archive -->
              <span class="ApplicantArchive absolute">
                  <a href="#allocateProfileModal" data-toggle="modal" data-status="Applicant_Archive" class="tooltips counter" data-container="body" data-placement="top" data-original-title="Applicants in Archive ">{!! $num_54 !!}</a>
...
<script>
 ...
 $(document).on("click",".filter_report",function(){
    $('#Generations_AjaxLoader').show();
        ...
        var formdata = 'date1='+$('#date1').val()
                              +'&date2='+$('#date2').val()+'&departmentFilter='+$('#departmentFilter').val()+'&subjectFilter='+$('#subjectFilter').val()+'&designationFilter='+$('#designationFilter').val()+'&campusFilter='+$('#campusFilter').val()+'&formSourceFilter='+$('#formSourceFilter').val()
                               
                           console.log('form data=> '+formdata);
                            $.ajax({
                                type:'get',
                                 url:'/gsims/public/staff_recruitment_process_flow_filter',
                                data:formdata,
                                //dataType:'json',
