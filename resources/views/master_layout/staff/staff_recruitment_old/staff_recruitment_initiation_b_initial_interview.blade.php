            <div id="previous_process_2" class="relative processSkipped">
              <div class="overlayTOP" id="skip_msg_2">
                  <span class="centerPosition"><strong>Intial Interview:</strong> Previous process is still pending. Please complete the process. 
               </div>
            </div>
...
<!--             <div id="skipped_process_2" class="relative processSkipped">
            ...
            <div id="presence_2" class="relative processPresence">
              <div class="overlayTOP">
            ...
            <div id="main_div_2" class="relative hide">
<!--              <div class="overlayTOP">
                     ...
                     <td>
                        <div class="row">
                           ...
                           <div class="col-md-12 text-center marginTop20">
                              <input type="button" class="btn btn-group green" value="Submit" onClick="insertForm(2,1,8)">
                           </div><!-- col-md-12 -->
                        </div><!-- row -->
                     </td>
                  </tr>
