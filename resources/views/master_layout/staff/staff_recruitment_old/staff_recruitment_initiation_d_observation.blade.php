            <div id="previous_process_4" class="relative processSkipped">
              <div class="overlayTOP">
                  <span class="centerPosition"><strong>Observation Interview:</strong> Previous process is still pending. Please complete the process. 
               </div>
            </div>
<!-- 
            ...
            <div id="presence_4" class="relative processPresence">
              <div class="overlayTOP">
                  <span class="centerPosition"><strong>Observation Interview</strong> <br /><input type="button" class="btn btn-group green mark_present" value="Mark as Present" name="" data-id="4"></span>
               </div>
            </div>
            <div id="main_div_4" class="relative hide">
<!--              <div class="overlayTOP">
                     ...
                     <td>
                        <div class="row">
                           ...
                           <div class="col-md-12 text-center marginTop20">
                              <input type="button" class="btn btn-group green" value="Submit" onClick="insertForm(4,1,8)">
                           </div><!-- col-md-12 -->
                        </div><!-- row -->
                     </td>
                  </tr>
