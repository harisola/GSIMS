            <div id="previous_process_5" class="relative processSkipped">
              <div class="overlayTOP">
                  <span class="centerPosition"><strong>Final Consultation:</strong> Previous process is still pending. Please complete the process. 
               </div>
            </div>
...
<!--                         <div id="skipped_process_5" class="relative processSkipped">
            ...
            <div id="presence_5" class="relative processPresence">
              <div class="overlayTOP">
            ...
            <div id="main_div_5" class="relative hide">
<!--              <div class="overlayTOP">
                  ...
                  <tr>
                     ...
                     <td>
                        <div class="row">
                           ...
                           <div class="col-md-6 " style="padding-right:5px;">
                              <input type="date" class="form-control" id="applicant_next_step_allocation_date_5">
                           </div><!-- col-md-6 -->
                           <div class="col-md-6  " style="padding-left:5px;">
                     ...
                     <td>
                        <div class="row">
                           ...
                           <div class="col-md-12 text-center marginTop20">
                              <input type="button" class="btn btn-group green" value="Submit" onClick="insertForm(5,1,8)">
                           </div><!-- col-md-12 -->
                        </div><!-- row -->
                     </td>
                  </tr>
