                                ...
                                <div class="tab-pane" id="tab_education_edit">
                                  <form class="form-horizontal">
                                   ...
                                   @foreach ($education as $educations)
                                    @if ($educations->level==1)
                                    <div class="row school_row" style="padding-bottom: 20px;" id="add_school_more">
                                      <div class="form-body">
                                        <?php $school_inc=$school++; ?>
                                        <div class="col-md-12 school_row_{{$school_inc}}" >
                                          <div class="col-md-4 school_name_{{$school_inc}} ">
                                            <!-- zkkk -->
                                              <label class="control-label">School Name <span class="required">*</span></label>
                                              <select class="schoolName form-control" id="txt_schName" data-rowid={{$school_inc}} data-school_dd_name='school_dd{{$school_inc}} '>
                                                <option <?php if ($educations->title == "ACE_School" ) echo 'selected' ; ?> value="{{$educations->institute}}">ACE School</option>
                                                ...
                                                <!-- <option < //?/php if ($educations->title == $educations->title ) echo 'selected' ; ?> value="$educations->title"> {{$educations->institute}} </option> -->
                                                <option value="Other"> Other </option>

                                              </select><!-- -->
                                              <input type="text" class="form-control school_text_name_{{$school_inc}}" id="schoolname_textbox" style="display: none;">
                                              <label class="control-label close_school_name close_school_name_{{$school_inc}}" id="{{$school_inc}}" style="display: none;">Close</label>
                                              <!-- <a href="" class="closeOther" id="close_school_name" style="display: none;">close</a> -->
                                          </div><!-- col-md-4 zk -->
                                          <div class="col-md-2 school_qua_{{$school_inc}}">
                                              <label class="control-label">Qualification <span class="required">*</span></label>
                                              <select name="schoolQualification[]" class="schoolQualification valid form-control" data-rowid={{$school_inc}} data-school_dd_qua='school_qua_dd{{$school_inc}} ' id="schoolQ">
                                              ...
                                              <input type="text" class="form-control school_text_qualification_{{$school_inc}}" id="txt_qualification" style="display: none;">
                                              <label class="control-label close_school_qua close_school_qua_{{$school_inc}}" id="{{$school_inc}}" style="display: none;">Close</label>
                                              <!-- <a href="#" class="closeOther" style="display: none;">close</a> -->
                                          </div><!-- col-md-2 -->
                                          <div class="col-md-2 school_sub_{{$school_inc}}">
                                              <label class="control-label">Subject <span class="required">*</span></label>
                                              <select name="schoolSubject[]" class="schoolSubject valid form-control " data-rowid={{$school_inc}} data-school_dd_subject='school_sub_dd{{$school_inc}} ' id="schoolS" >
                                              ...
                                              <input type="text" class="form-control school_text_subject_{{$school_inc}}" id="txt_subject" style="display: none;">
                                              <label class="control-label close_school_sub close_school_sub_{{$school_inc}}" id="{{$school_inc}}" style="display: none;">Close</label>
                                              <!-- <a href="#" class="closeOther" style="display: none;">close</a> -->
                                          </div><!-- col-md-2 -->
                                          <div class="col-md-2 school_result_{{$school_inc}}">
                                              <label class="control-label">Result <span class="required">*</span></label>
                                              <input type="text" class="form-control school_result_{{$school_inc}}" name="" id="result_school" value="{{ $educations->result }}">
                                          </div><!-- col-md-2 -->
                                          <div class="col-md-2 school_year_{{$school_inc}}">
                                              <label class="control-label">Year <span class="required">*</span></label>
                                              <input type="text" id="school_year" class="form-control school_year" name="school_year" value="{{ $educations->year_of_completion }}">
                                          </div><!-- col-md-2 -->
                                        </div>
                                      </div><!-- form-body -->
                                    </div>
                                    ...
                                    <?php $college=1; ?>
                                    @foreach($education as $educations)
                                    @if($educations->level==2)
                                    <div class="row college_row" style="padding-bottom: 20px;" id="add_college_more">
                                      <div class="form-body">
                                        <?php $college_inc=$college++; ?>
                                        <div class="col-md-12 college_row_{{$college_inc}}" >
                                          <div class="col-md-4 college_name_{{$college_inc}}" >
                                              <label class="control-label">College Name <span class="required">*</span></label>
                                              <input type="text" class="form-control college_text_name_{{$college_inc}}" id="college_name"  value="{{ $educations->institute }}">
                                          </div><!-- col-md-4 -->
                                          <div class="col-md-2 college_qua_{{$college_inc}}">
                                              <label class="control-label">Qualification <span class="required">*</span></label>
                                              <select name="collegeQualification[]" class="collegeQ valid form-control college_qualification_{{$college_inc}}" data-rowid={{$college_inc}} data-college_dd_qua='college_qua_dd{{$college_inc}} ' id="collegeQ">
                                                <!-- <option value="{{ $educations->qualification }}">{{ $educations->qualification }}</option> -->
                                              ...
                                              <input type="text" class="form-control college_text_qualification_{{$college_inc}}" id="txt_qualification" style="display: none;">
                                              <label class="control-label close_college_qua close_college_qua_{{$college_inc}}" id="{{$college_inc}}" style="display: none;">Close</label>
                                              <!-- <a href="#" class="closeOther" style="display: none;">close</a> -->
                                          </div><!-- col-md-2 -->
                                          <div class="col-md-2 college_sub_{{$college_inc}}">
                                              <label class="control-label">Subject <span class="required">*</span></label>
                                              <select name="collegeSubject[]" class="collegeS slct_clgSub valid form-control college_subject_{{$college_inc}}" data-rowid={{$college_inc}} data-college_dd_subject='college_sub_dd{{$college_inc}} ' id="collegeS">
                                              ...
                                              <input type="text" class="form-control college_text_subject_{{$college_inc}}" id="txt_subject"  style="display: none;">
                                              <label class="control-label close_college_sub close_college_sub_{{$college_inc}}" id="{{$college_inc}}" style="display: none;">Close</label>
                                              <!-- <a href="#" class="closeOther" style="display: none;">close</a> -->
                                          </div><!-- col-md-2 -->
                                          <div class="col-md-2 college_result_{{$college_inc}}">
                                              <label class="control-label">Result <span class="required">*</span></label>
                                              <input type="text" class="form-control college_result_{{$college_inc}}" name="" id="result_college" value="{{ $educations->result }}">
                                          </div><!-- col-md-2 -->
                                          <div class="col-md-2 college_year_{{$college_inc}}">
                                              <label class="control-label">Year <span class="required">*</span></label>
                                              <input type="text" class="form-control college_year" name="" id="year_college" value="{{ $educations->year_of_completion }}">
                                          </div><!-- col-md-2 -->
                                        </div>
                                      </div><!-- form-body -->
                                    </div>
                                    ...
                                    <?php $university=1; ?>
                                    @foreach($education as $educations)
                                    @if($educations->level==3)
                                    <div class="row university_row" style="padding-bottom: 20px;" id="add_university_more">
                                      <div class="form-body">
                                        <?php $university_inc=$university++; ?>
                                        <div class="col-md-12 university_row_{{$university_inc}}" >
                                          <div class="col-md-4 university_name_{{$university_inc}}" >
                                              <label class="control-label">University Name <span class="required">*</span></label>
                                              <select name="universityName[]" class="universityN slct_uniname form-control" data-rowid={{$university_inc}} data-university_dd_name='university_dd{{$university_inc}} ' id="university_name">
                                                ...
                                                <option <?php if ($educations->title == $educations->institute ) echo 'selected' ; ?> value="$educations->title"> {{$educations->institute}} </option>
                                                <option value="Other"> Other </option>
                                              </select><!-- -->
                                              <input type="text" class="form-control university_text_name_{{$university_inc}}" id="universityname_textbox" style="display: none;">
                                              <label class="control-label close_university_name close_university_name_{{$university_inc}}" id="{{$university_inc}}" style="display: none;">Close</label>
                                              <!-- <a href="#" class="closeOther" style="display: none;">close</a> -->
                                          </div><!-- col-md-4 -->
                                          <div class="col-md-2 university_qua_{{$university_inc}}">
                                              <label class="control-label">Qualification <span class="required">*</span></label>
                                              <select name="universityQualification[]" class="universityQ slct_uniqual form-control" data-rowid={{$university_inc}} data-university_dd_qua='university_qua_dd{{$university_inc}} ' id="universityQ" >
                                                ...
                                                <option <?php if ($educations->qualification == "$educations->qualification" ) echo 'selected' ; ?>  value="{{ $educations->qualification }}">{{ $educations->qualification }}</option>
                                              ...
                                              <input type="text" class="form-control university_text_qualification_{{$university_inc}}" style="display: none;">
                                              <label class="control-label close_university_qua close_university_qua_{{$university_inc}}" id="{{$university_inc}}" style="display: none;">Close</label> 
                                              <!-- <a href="#" class="closeOther" style="display: none;">close</a> -->
                                          </div><!-- col-md-2 -->
                                          <div class="col-md-2 university_sub_{{$university_inc}}">
                                              <label class="control-label">Subject <span class="required">*</span></label>
                                              <select name="universitySubject[]" class="universityS slct_unisubjct form-control" data-rowid={{$university_inc}} data-university_dd_sub='university_sub_dd{{$university_inc}} ' id="universityS">
                                                <option <?php if ($educations->subjects == $educations->subjects ) echo 'selected' ; ?> value="$educations->subjects"> {{$educations->subjects}} </option>
                                              ...
                                              <input type="text" class="form-control university_text_subject_{{$university_inc}}" style="display: none;">
                                              <label class="control-label close_university_sub close_university_sub_{{$university_inc}}" id="{{$university_inc}}" style="display: none;">Close</label> 
                                              <!-- <a href="#" class="closeOther" style="display: none;">close</a> -->
                                          </div><!-- col-md-2 -->
                                          <div class="col-md-2 university_result_{{$university_inc}}">
                                              <label class="control-label">Result <span class="required">*</span></label>
                                              <input type="text" class="form-control" name="" id="result_university{{$university_inc}}" value="{{ $educations->result }}">
                                          </div><!-- col-md-2 -->
                                          <div class="col-md-2 university_year_{{$university_inc}}">
                                              <label class="control-label">Year <span class="required">*</span></label>
                                              <input type="text" class="form-control university_year" name="" id="university_year" value="{{ $educations->year_of_completion }}">
                                          </div><!-- col-md-2 -->
                                        </div>
                                      </div><!-- form-body -->
                                    </div>
                                    ...
                                    <?php $professional=1; ?>
                                    @foreach($education as $educations)
                                    @if($educations->level==4)
                                    <div class="row professional_row" style="padding-bottom: 20px;" id="add_professional_more">
                                      <div class="form-body">
                                        <?php $professional_inc=$professional++; ?>
                                        <div class="col-md-12 professional_row_{{$professional_inc}}" >
                                          <div class="col-md-4 professional_name_{{$professional_inc}}" >
                                              <label class="control-label">Professional Name <span class="required">*</span></label>
                                              <input type="text" class="form-control professional_text_name_{{$professional_inc}}" id="professional_name" value="{{ $educations->institute }}">
                                          </div><!-- col-md-4 -->
                                          <div class="col-md-2 professional_qua_{{$professional_inc}}">
                                              <label class="control-label">Qualification <span class="required">*</span></label>
                                              <input type="text" class="professionalQ form-control professional_text_qualification_{{$professional_inc}}" id="professionalQ" value="{{ $educations->qualification }}">
                                          </div><!-- col-md-2 -->
                                          <div class="col-md-2 professional_sub_{{$professional_inc}}">
                                              <label class="control-label">Subject <span class="required">*</span></label>
                                              <input type="text" class="form-control professional_text_subject_{{$professional_inc}}" id="professionalS" value="{{ $educations->subjects }}">
                                          </div><!-- col-md-2 -->
                                          <div class="col-md-2 professional_result_{{$professional_inc}}">
                                              <label class="control-label">Result <span class="required">*</span></label>
                                              <input type="text" class="form-control professional_result_{{$professional_inc}}" name="" id="result_professional" value="{{ $educations->result }}">
                                          </div><!-- col-md-2 -->
                                          <div class="col-md-2 professional_year_{{$professional_inc}}">
                                              <label class="control-label">Year <span class="required">*</span></label>
                                              <input type="text" class="form-control professional_year" name="" id="year_professional" value="{{ $educations->year_of_completion }}">
                                          </div><!-- col-md-2 -->
                                        </div>
                                      </div><!-- form-body -->
                                    </div>
                                    ...
                                    <?php $others=1;
                                     ...
                                     ?>
                                    @foreach($education as $educations)
                                    @if($educations->level==5)
                                    <div class="row others_row" style="padding-bottom: 20px;" id="add_others_more">
                                      <div class="form-body">
                                        <?php $others_inc=$others++; ?>
                                        <div class="col-md-12 others_row_{{$others_inc}}" >
                                          <div class="col-md-4 others_name_{{$others_inc}}" >
                                              <label class="control-label">Others Name <span class="required">*</span></label>
                                              <input type="text" value="{{$educations->institute}}" class="form-control college_text_name_{{$others_inc}}" id="others_name">
                                          </div><!-- col-md-4 -->
                                          <div class="col-md-2 others_qua_{{$others_inc}}">
                                              <label class="control-label">Qualification <span class="required">*</span></label>
                                              <input type="text" class="form-control others_text_qualification_{{$others_inc}}" id="othersQ" value="{{$educations->qualification}}">
                                          </div><!-- col-md-2 -->
                                          <div class="col-md-2 others_sub_{{$others_inc}}">
                                              <label class="control-label">Subject <span class="required">*</span></label>
                                              <input type="text" class="othersS form-control others_text_subject_{{$others_inc}}" id="othersS" value="{{$educations->subjects}}">
                                          </div><!-- col-md-2 -->
                                          <div class="col-md-2 others_result_{{$others_inc}}">
                                              <label class="control-label">Result <span class="required">*</span></label>
                                              <input type="text" class="form-control others_result_{{$others_inc}}" name="" id="result_others" value="{{$educations->result}}">
                                          </div><!-- col-md-2 -->
                                          <div class="col-md-2 others_year_{{$others_inc}}">
                                              <label class="control-label">Year <span class="required">*</span></label>
                                              <input type="text" class="form-control others_year" name="" id="others_year" value="{{$educations->year_of_completion}}">
                                          </div><!-- col-md-2 -->
                                        </div>
                                      </div><!-- form-body -->
                                    </div>
