                                      ...
                                      <div class="row marginBottom20">
                                         ...
                                         <div class="col-md-6">
                                            <div class="form-group">
                                               ...
                                               <div class="col-md-9">
                                                  <input type="text" class="form-control" placeholder="" id="ntn_no" value="{{ $other[0]->ntn }}">
                                               </div>
                                            </div>
                                         </div>
                                         <!--/span-->
                                      ...
                                      <div class="row marginBottom20">
                                         <div class="col-md-6">
                                            <div class="form-group">
                                               ...
                                               <div class="col-md-9">
                                                  <input type="text" class="form-control" placeholder="" id="eobi_no" value="{{ $other[0]->eobi }}">
                                               </div>
                                            </div>
                                         </div>
                                         <!--/span-->
                                         <div class="col-md-6">
                                            <div class="form-group">
                                               ...
                                               <div class="col-md-9">
                                                  <input type="text" class="form-control" placeholder="" id="sessi_no" value="{{ $other[0]->sessi }}">
                                               </div>
                                            </div>
                                         </div>
                                         <!--/span-->
                                      ...
                                      <div class="row marginBottom20">
                                         <div class="col-md-6">
                                            <div class="form-group">
                                               ...
                                               <div class="col-md-9">
                                                  <input type="text" class="form-control" placeholder="" id="bank_name_txt" value="{{ $other[0]->bank_name }}">
                                               </div>
                                            </div>
                                         </div>
                                         <!--/span-->
                                         <div class="col-md-6">
                                            <div class="form-group">
                                               ...
                                               <div class="col-md-9">
                                                  <input type="text" class="form-control" placeholder="" id="bank_branch_name" value="{{ $other[0]->bank_branch }}">
                                               </div>
                                            </div>
                                         </div>
                                         <!--/span-->
                                      ...
                                      <div class="row">
                                         <div class="col-md-6">
                                            <div class="form-group">
                                               ...
                                               <div class="col-md-9">
                                                  <input type="text" class="form-control" placeholder="BBBB-AAAAAAAAAA" id="bank_account_number" value="{{ $other[0]->account_number }}">
                                               </div>
                                            </div>
                                         </div>
                                         <!--/span-->
                                      ...
                                      <div class="row marginBottom20">
                                         ...
                                         <div class="col-md-6">
                                            <div class="form-group">
                                               ...
                                               <div class="col-md-9">
                                                  <input type="text" class="form-control" placeholder="" id="c_takaful" value="{{ $other[0]->takaful_crt }}">
                                               </div>
                                            </div>
                                         </div>
                                         <!--/span-->
                                      ...
                                      <div class="row">
                                         <div class="col-md-6">
                                            <div class="form-group">
                                               ...
                                               <div class="col-md-9">
                                                  <textarea class="form-control" rows="3" id="reason_for_takaful" value="">{{ $other[0]->takaful_reasons }}</textarea>
                                               </div>
                                            </div>
                                         </div>
                                         <!--/span-->
