...
<input type="hidden" id="photo150_staff" value="<?php echo $Current_user_pic["photo150"];?>" />
                ...
                <div class="table-scrollable table-scrollable-borderless">
	                ...
	                <div style="position: absolute;bottom: -310px;left: 32px;">
		                        ...
		                        <div class="theme-options4">
                                    ...
                                    <div class="theme-option">
                                        ...
                                        <select id="Sort_By_User" class="layout-option form-control input-sm">
                                           <option value="371">Farah</option>
                                           <option value="624">Zulfiqar</option>
                                           <option value="811">Salman</option>
                                           <option value="482">Ayaz</option>
                                        </select>
                                    </div>
                            ...
                            <ul class="chats" id="Stories_Chats">
                                ...
                                */ ?>
                                ...
                                <div class="col-md-12 text-center" style="padding: 10px 0 30px;">
								    <a href="#" id="loadMore" style="margin-top: 20px;">Load More</a> 
                                </div>
...
//Assign table rows to tableRecords
 ...
 $("#staffView_StaffList_Search").keyup(function(){
	...
	$('#staffView_search_btn33 .applySearch').click(function() {
		...
		var LoadMore_E_Student_id = parseInt($("#LoadMore_E_Student_id").val());
