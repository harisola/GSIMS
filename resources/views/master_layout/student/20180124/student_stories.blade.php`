                        ...
                        <div class="theme-options">
                          <div class="theme-option">
                            <span> Grade </span>
								...
								<span> Section </span>
								<?php /* ?>
								<select multiple="multiple" data-attribute="grade_section" id="Multiple_Section_id" style="display:none;" class="ddlFilterTableRow Grade_PG page-header-option form-control input-sm multiselect">
								...
								<select multiple="multiple" data-attribute="grade_section" id="Multiple_Section_id" style="display:none;" class="ddlFilterTableRow North_C page-header-option form-control input-sm multiselect">
								...
								<select multiple="multiple" data-attribute="grade_section" id="Multiple_Section_id" style="display:none;" class="ddlFilterTableRow Section_ids_full page-header-option form-control input-sm multiselect">
								...
								<select multiple="multiple" data-attribute="grade_section" id="Multiple_Section_id" class="ddlFilterTableRow Full_School page-header-option form-control input-sm multiselect">
	                             ...
	                             <td class="studentView_StudentName">
	                                <a href="javascript:;" class="primary-link tooltips" data-container="body" data-placement="top" id="{{ $student->Student_id }}_{{ $student->gs_id }}" data-original-title="GS-ID: {{ $student->gs_id }}"> {{ $student->abridged_name }} </a><br>
	                                 ...
	                                 <span class="class_Name BoySta" style="margin-left:10px;">
										...
										<span class="StuStatus tooltips" data-placement="top" data-original-title="House: {{ $student->house_name }}" data-pin-nopin="true"><?php  echo substr($student->house_name, 0, 1); ?></span>
	                                </span>
...
$(document).on("click", "#add_badge", function (e) {
    ...
    //var comments_cat = $('#Add_call_story .modal-body #Dropdown_Comment_Category').val();
