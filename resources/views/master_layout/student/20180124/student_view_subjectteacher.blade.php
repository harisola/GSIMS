...
$Total_Students_Last10Days = 0;
$Total_Students_Last60Days = 0;
$Fence_Total =0; 


	if( !empty($Students) ){
		$ClassTitle = $cTitle;
		if(isset($Students[0]->Grade_id)){
          $Grade_id = $Students[0]->Grade_id;
          $Section_id = $Students[0]->Section_id;
          $Acadmic = $Students[0]->Acadmic;
		  
		  $Grade_Grade_Total =    count($Students);
        } 
            ...
            $Total_Students_Last10Days += $S->total_pf; // Count All student present in last 10 days
            $Total_Students_Last60Days += $S->total_ps; // Count All student present in last 60 days
			
			
			if( $S->Student_Status == 'Fence' ){
				$Fence_Total += $S->Student_Status;	
			}
			if( $S->Today_Tapin_Time != 0 ){
			...
			$Grade_Grade_Total2 = (int)($Grade_Grade_Total);
			
			
			
			$Grade_Grade_Total3= ($Grade_Grade_Total - $Fence_Total);
			
			$Percentage_Today_Total =  round( (( $Today_Total_Presents / $Grade_Grade_Total2 ) * 100 ),0,PHP_ROUND_HALF_UP ); // percentage score
			
			
			
            $num = ( $Today_Total_Presents / $Grade_Grade_Total2 );
			
            $Today_Score = round( ( $num * 10 ) ,1 );
			
            $T10Days = $Students[0]->total_wdf;
            $T60Days = $Students[0]->total_wds;
           // $Total_Students_Last10Days = 0;
           // $Total_Students_Last60Days = 0;
            ...
            $TenDaysDividedBy = ($Grade_Grade_Total2*$T10Days);
            $TenDaysDividedResult = 0;
            if($TenDaysDividedBy != 0){
              $TenDaysDividedResult = ($Total_Students_Last10Days/$TenDaysDividedBy);
            }
            $Grade_Total_10Days = round(($TenDaysDividedResult*10),1);
            
            
            $TenDaysDividedB = ($Grade_Grade_Total2*$T60Days);
            $TenDaysDividedResul = 0;
            if($TenDaysDividedB != 0){
              $TenDaysDividedResul = ($Total_Students_Last60Days/$TenDaysDividedB);
            }
            $Grade_Total_60Days = round(($TenDaysDividedResul*100),1);
            
            $Percentage_Today_Total_Absent = round( (($Today_Total_Absent/$Grade_Grade_Total2)*100),0,PHP_ROUND_HALF_UP ); // Absent Percentage_Today_Total
            ...
            <div class="showOnlyOnScroll">
                ...
                <div class="caption caption-md col-md-12 padding0">
                    ...
                    <div class="col-md-12 text-center padding0">
                        <h3 class="classDetails"><span class="grayish">CLASS</span> <?=$ClassTitle;?> &nbsp; 
                    ...
                    <table class="table table-hover table-light" id="staffView_Table_StaffList">
                        ...
                        <tr>
							...
							?>
                                ...
                                <img style="margin-top: 6px;" src="http://10.10.10.50/gsims/public/metronic/pages/img/<?=$Student->IconTapInOn;?>" class="popovers" data-container="body" data-trigger="hover" data-placement="top" data-content="Tap In at <?=$Today_Tapin_Time;?>" data-original-title="<?=$Student->TitleTapInOn;?>" width="25">
                                </span>
                        ...
                        <?php else: ?>
						<tr id="LastRow2">
							<td colspan="5" class="font-red">No record found! Try something else.</td>
						</tr>
						<?php endif; ?>
                ...
                <div class="portlet light bordered padding0 marginBottom0">
                    <div class="portlet-body padding20">
                        <ul class="nav nav-tabs" id="credit">
                            <li class="active" data-interest="Comments">
                                <a href="#tab_1_9" data-toggle="tab"> Stories </a>
                            </li>
							
                            <li class="" data-interest="Basic">
                                <a href="#tab_1_1" data-toggle="tab"> Basic </a>
                            </li>
							
                            <li data-interest="sms">
                                <a href="#tab_1_2" data-toggle="tab"> SMS </a>
                            </li>
                            <li data-interest="Attendance">
                                <a href="#tab_1_3" data-toggle="tab"> Attendance </a>
                            </li>
                            <li data-interest="Grade">
                                <a href="#tab_1_4" data-toggle="tab"> Grade </a>
                            </li>
                            <li data-interest="Billing">
                                <a href="#tab_1_5" data-toggle="tab"> Billing </a>
                            </li>
                            <li data-interest="Discount">
                                <a href="#tab_1_6" data-toggle="tab"> Discount </a>
                            </li>
                            <li data-interest="Arrears/Advance">
                                <a href="#tab_1_7" data-toggle="tab"> Arrears/Advance </a>
                            </li>
                            <!-- <li data-interest="Log">
                                <a href="#tab_1_8" data-toggle="tab"> Log </a>
                            </li> -->
                        </ul>
...
$.ajax({
 ...
 $('#btn_Add_Comments').click(function(e) {
	...
	if( ( Search_Area != '' ) && ( arrType.length > 0 ) && (indFam.length >0) ){
		...
		//html +='<span class="commentCat '+Tag_Category.replace(",", "")+' "> '+Tag_Category+' </span>';
...
if( category== 'SIS' ||  category== 'Etab' || category== 'Accounts' || category== 'Academic' ){ $(this).show(); }else{ $(this).hide();}
	...
	$('#staffView_search_btn33 .applySearch').click(function() {
		...
		var checked = []
		$("input[name='Search_Cat[]']:checked").each(function (){ checked.push($(this).val()); });
