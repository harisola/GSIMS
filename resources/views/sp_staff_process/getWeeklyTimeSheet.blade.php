            ...
            <div class="col-md-12 paddingRight0">
                <div class="portlet light bordered padding0 marginBottom0">
                    ...
                    <div class="portlet-body padding20">
                        ...
                        <form action=""  id="">
                            <h4 class="form-section headingBorderBottom">Weekly Timesheet SP</h4>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-4">
                                	<button type="button" class="btn blue" id="btn_weeklyTimeSheet">Initiate Process</button>
                                </div>
                                <!--/span-->
                            </div><!-- -->
...
var pagefunction = function() {
    ...
    document.getElementById("btn_weeklyTimeSheet").addEventListener("click", function(){
        ...
        request.open("POST", "{{url('/updateSpOfWeeklySheet')}}", true);
        request.setRequestHeader('Content-Type', 'application/x-www-form-urlencoded; charset=UTF-8');
        request.setRequestHeader('X-CSRF-TOKEN', token);
        request.send("from_date="+from_date+"&to_date="+to_date);
