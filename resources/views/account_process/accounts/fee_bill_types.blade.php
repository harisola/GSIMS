...
<!--                     	<li class=""><a href="">PAO</a></li>
                        ...
                        @foreach ($fee_bill_type as $billType)
                            <li class=""><a href="javascript:" onclick="mappingBillType({{$billType->id}})">{{ $billType->title }}</a></li>
                        @endforeach
        ...
        <div class="row">
            <div class="col-md-12 ">
                <div class="portlet light bordered padding0 marginBottom0">
                    ...
                    <form method="POST" action="{{ url('/updateBillType') }}" id="formBillType">
