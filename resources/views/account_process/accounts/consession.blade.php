...
$.ajax({
    type:'POST',
    data: {'_token': '{{ csrf_token() }}','Formdata': $("#Form_add_concession").serialize() },
    url:"{{url('/add_concession')}}",
    dataType: "json",
    async: false,
    cache: false,
    success: function(response)
    ...
    $.ajax({
       type:'POST',
       data: {'_token': '{{ csrf_token() }}', 'Gs_id':Gs_id, 'Academic_session_id':Academic_session_id },
       url:"{{url('/student_concession_info')}}",
       dataType: "json",
       async: false,
       cache: false,
       success: function(response)
...
App.startPageLoading(); 
    ...
    $.ajax({
       type:'POST',
       data: {'_token': '{{ csrf_token() }}', 'Gs_id':Gs_id, 'tableType':tableType },
       url:"{{url('/concession_search2')}}",
       dataType: "json",
       async: false,
       cache: false,
       success: function(response)
