<table class="table table-striped table-bordered" cellspacing="0" id="datatable_ajax_demo">
    ...
    <tbody> 
        ...
        @php if( !empty($MIS_Data) ) : @endphp
        @php foreach($MIS_Data as $d) : @endphp
        <tr role="row">
            <td> @php echo $counter @endphp </td>
            <td> @php echo $d->Bill_no @endphp </td>
            <td> @php echo $d->Gs_id @endphp </td>
            <td> @php echo $d->Abridged_name @endphp </td>
            <td> @php echo $d->Grade_Section @endphp </td>
            <td> @php echo $d->Additional_late_fee @endphp </td>
            <td> @php echo $d->Current_billing_amount @endphp </td>
            <td> @php echo $d->Arrears @endphp </td>
            <td> @php echo $d->Amount_before @endphp </td>
            <td> @php echo $d->Amount_after @endphp </td>
            <td> @php echo $d->Bill_due_date @endphp </td>
