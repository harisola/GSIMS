        ...
        <div class="portlet light bordered padding0 marginBottom0">
            ...
            <div class="portlet-title">
                <div class="caption add_profile_label">
                    ...
                    <span class="caption-subject font-dark sbold uppercase caption_subject_profile">Session - <b>{{ $Academic_dname }}</b></span>
                    <input type="hidden" name="Academic_id" id="Academic_id" value="{{ $Academic_id }}" />
                </div>
            </div><!-- portlet-title -->
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" id="Session_name" name="Session_name" class="form-control" placeholder=" 2018-2019" value="{{ $Session_name  }}" />
                            </div>
                        </div>
                        <!--/span-->
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" id="Academic_dname" name="Academic_dname" class="form-control" placeholder="2018-19" value="{{ $Academic_dname  }}" />
                            </div>
                        </div>
                        <!--/span-->
                    </div>
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="date" id="Academic_Start_date" name="Academic_Start_date" class="form-control" placeholder="" value="{{ $Academic_Start_date  }}" />
                            </div>
                        </div>
                        <!--/span-->
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="date" id="Academic_End_date" name="Academic_End_date" class="form-control" placeholder="" value="{{ $Academic_End_date  }}" />
                            </div>
                        </div>
                        <!--/span-->
                    </div>
                        ...
                        <div class="tab-content">
                            <div class="tab-pane active" id="tab_15_1">
                                ...
                                <table class="table table-bordered" id="FeeStructure">
                                    <thead>
                                        <tr>
                                            <th class="text-center">{{ $Academic_dname  }}</th>
                                        ...
                                        <?php if( !empty( $staffRecruiment   ) ) : ?>
                                            <?php foreach( $staffRecruiment as $sr ) : ?>
                                                ...
                                                <tr>
                                                    ...
                                                    <input type="hidden" name="Grade_id[]" class="Grade_id" value="{{ $sr->Grade_id }}" />

                                                    <input type="hidden" name="Definition_id[]" class="Definition_id" value="{{ $sr->Definition_id }}" />

                                                    <td class="text-center">{{ $sr->Grade_name }}</td>

                                                    <input type="hidden" class="shortFields" value="Row_{{ $sr->Definition_id }}" />

                                                    <td class="text-center">
                                                    <input type="number" class="shortField" value="{{ $sr->Tuition_fee }}" name="Tution_Fee_{{$sr->Definition_id}}" /> 
                                                    </td>
                                                    ...
                                                    <td class="text-center">
                                                        {{ 
                                                        number_format($sr->Total, 0,'',',' )
                                                         }}
                                                     </td>

                                                    <td class="text-center"><input type="number" class="shortField" value="{{ $sr->Yearly_fee }}" name="Yearly_fee_{{$sr->Definition_id}}" /></td>
                                                     ...
                                                     <td class="text-center">
                                                        ...
                                                        {{ 
                                                        number_format($sr->Total_year_charges, 0,'',',' )
                                                         }}
                                                    </td>
